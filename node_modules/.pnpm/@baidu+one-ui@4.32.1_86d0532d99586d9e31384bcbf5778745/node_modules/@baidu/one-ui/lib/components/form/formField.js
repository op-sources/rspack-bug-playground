...
var FormField = /*#__PURE__*/function (_PureComponent) {
  ...
  _proto.renderFieldNode = function renderFieldNode() {
    ...
    if (name && form && /*#__PURE__*/_react["default"].isValidElement(children)) {
      ...
      fieldNode = /*#__PURE__*/_react["default"].cloneElement(children, {
        className: (0, _commonTools.classnames)(children.props.className, (_classnames = {}, _classnames[_config.COMPONENT_INVALID] = validateStatus === 'error' || !(0, _isEmpty2["default"])(form.getFieldError(name)), _classnames))
      });
      var options = {
        rules: rules,
  ...
  _proto.renderField = function renderField(formContext) {
    ...
    return /*#__PURE__*/_react["default"].createElement("div", {
      className: (0, _commonTools.classnames)(className, this.className(), (_classnames2 = {}, _classnames2[this.className('abstract')] = _abstract4, _classnames2[this.className('actions')] = actions, _classnames2[this.className('standalone')] = display === 'standalone', _classnames2)),
      style: style
  ...
  _proto.renderLabel = function renderLabel(helpNode) {
    ...
    if (label != null && !_abstract5) {
      ...
      return /*#__PURE__*/_react["default"].createElement("div", {
        className: (0, _commonTools.classnames)(this.className('label'), (_classnames3 = {}, _classnames3[this.className('label-left')] = labelAlign === 'left', _classnames3[this.className('label-required')] = this.required(), _classnames3[this.className('label-align-help')] = help && labelPosition === 'side' && helpPosition === 'top', _classnames3))
...
FormField.contextType = _context.FormFieldContext;

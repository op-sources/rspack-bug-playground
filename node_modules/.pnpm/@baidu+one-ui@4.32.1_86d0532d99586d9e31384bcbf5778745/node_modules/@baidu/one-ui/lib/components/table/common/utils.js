...
exports.uniformCalcWidth = exports.resetWidthByColumnsWidth = exports.recalcWidthWhenColumnsChange = exports.leafColumns = exports.isColumnWidthChange = exports.formatTableWidth = exports.formatTableWidthWithAllColumnsWidth = exports.formatCellLeft = exports.formatNormalWidth = exports.formatCellWidth = exports.expandIconWidth = void 0;
 ...
 * @date 2020-05-15
 */
var expandIconWidth = 38;
exports.expandIconWidth = expandIconWidth;

var formatCellWidth = function formatCellWidth(width, totalWidth) {
...
exports.formatCellWidth = formatCellWidth;

var formatNormalWidth = function formatNormalWidth(tableWidth, leftColumns) {
...
exports.formatNormalWidth = formatNormalWidth;

var formatCellLeft = function formatCellLeft(width, prevWidth, totalWidth) {
  if (!width) {
    return prevWidth;
  }
...
exports.formatCellLeft = formatCellLeft;

var formatTableWidthWithAllColumnsWidth = function formatTableWidthWithAllColumnsWidth(allColumnsWidth) {
...
exports.formatTableWidthWithAllColumnsWidth = formatTableWidthWithAllColumnsWidth;

var formatTableWidth = function formatTableWidth(bodyTable, scroll, expandedRowRender) {
  var bodyWidth;
...
exports.formatTableWidth = formatTableWidth;

var isColumnWidthChange = function isColumnWidthChange(originColumns, newColumns) {
...
exports.isColumnWidthChange = isColumnWidthChange;
...
var recalcWidthWhenColumnsChange = function recalcWidthWhenColumnsChange(allColumnsWidth, newColumns, oldColumns, tableWidth) {
...
exports.recalcWidthWhenColumnsChange = recalcWidthWhenColumnsChange;

var resetWidthByColumnsWidth = function resetWidthByColumnsWidth(newColumns, tableWidth) {
  if (newColumns === void 0) {
    newColumns = [];
  }
...
exports.resetWidthByColumnsWidth = resetWidthByColumnsWidth;

var uniformCalcWidth = function uniformCalcWidth(columns, tableWidth) {
...
exports.uniformCalcWidth = uniformCalcWidth;
...
var _virtualTreeNode = _interopRequireDefault(require("../../tree/common/virtualTreeNode"));

var _treeNode = _interopRequireDefault(require("../../tree/common/treeNode"));
...
var CandidatePane = /*#__PURE__*/function (_PureComponent) {
  (0, _inheritsLoose2["default"])(CandidatePane, _PureComponent);
  ...
  _proto.renderNode = function renderNode(key) {
    ...
    var CustomTreeNode = virtualListHeight ? _virtualTreeNode["default"] : _treeNode["default"];
    ...
    var candidateProps = (0, _extends2["default"])({}, candidateItem, {
      hasSearch: hasSearch,
    ...
    if (CandidateItem && typeof CandidateItem === 'function') {
      ...
      renderItem = /*#__PURE__*/_react["default"].createElement(CustomCandidateItemRender, candidateProps);
    } else if (CandidateItem && typeof CandidateItem === 'object') {
      renderItem = CandidateItem;
    } else {
      renderItem = /*#__PURE__*/_react["default"].createElement(_itemRender["default"], candidateProps);
    }
    ...
    var treeNodeProps = {
      ...
      isLeaf: isLeaf,
      loading: loading,
      title: isOverMaxNum ? /*#__PURE__*/_react["default"].createElement(_tooltip["default"], {
        title: "\u6570\u91CF\u5DF2\u8FBE\u4E0A\u9650\uFF0C\u8BF7\u5220\u9664\u540E\u6DFB\u52A0",
  ...
  _proto.render = function render() {
    ...
    var content = candidateList.length ? /*#__PURE__*/_react["default"].createElement(_tree["default"], (0, _extends2["default"])({}, treeProps, {
      ref: candidateTreeRef,
      key: "candidate-tree"
    }), this.candidateNodeTrees(candidateList)) : /*#__PURE__*/_react["default"].createElement(_stack["default"], {
      justify: "center",

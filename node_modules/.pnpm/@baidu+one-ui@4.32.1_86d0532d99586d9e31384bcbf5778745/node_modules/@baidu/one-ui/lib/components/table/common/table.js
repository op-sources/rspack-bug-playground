...
var _dragLine = _interopRequireDefault(require("./dragLine"));
...
var ComponentTable = /*#__PURE__*/function (_PureComponent) {
  (0, _inheritsLoose2["default"])(ComponentTable, _PureComponent);
  ...
  function ComponentTable(_props) {
    ...
    _this.handleHeadWheel = function (_ref) {
      var nativeEvent = _ref.nativeEvent;
      var deltaX = nativeEvent.deltaX,
    ...
    _this.handleWindowScroll = function () {
      ...
      if (headTable && bodyTable) {
        ...
        var isBottomScrollShow = bodyTableRect.bottom > (0, _commonTools.getWindowHeight)() - _this.props.bottomScroll.bottom && tableWidth > bodyTableRect.width;
    ...
    _this.renderMainTable = function (expander) {
      ...
      return /*#__PURE__*/_react["default"].createElement("div", {
        className: (0, _classnames2["default"])(prefixCls + "-main", (_classNames = {}, _classNames[prefixCls + "-scroll"] = scrollable, _classNames))
      }, table);
    };
    ...
    _this.columnManager = new _columnManager["default"](_props.columns);
    ...
    _this.debouncedWindowScroll = _this.handleWindowScroll.bind((0, _assertThisInitialized2["default"])(_this));
    _this.renderBottomScroll = _this.renderBottomScroll.bind((0, _assertThisInitialized2["default"])(_this));
    return _this;
  }
  ...
  _proto.componentDidMount = function componentDidMount() {
    ...
    var bodyWidth = (0, _utils.formatTableWidth)(bodyTable, scroll, this.props.expandedRowRender);
    var allColumnsWidth = this.columnManager.allColumnsWidth(bodyWidth);
    this.store.setState({
      allColumnsWidth: (0, _utils.uniformCalcWidth)(allColumnsWidth, bodyWidth)
    });
    ...
    if (this.headTable) {
      this.headTableWheelEvent = (0, _addEventListener["default"])(this.headTable, 'wheel', this.handleHeadWheel);
    }
    ...
    if (this.props.updateWidthChange) {
      var resize = (0, _throttle2["default"])(function () {
        ...
        var curBodyWidth = (0, _utils.formatTableWidth)(_this2.bodyTable, scroll, expandedRowRender);
        ...
        var allColumnsWidth = (0, _utils.recalcWidthWhenColumnsChange)(_this2.store.getState().allColumnsWidth, _this2.props.columns, _this2.props.columns, curBodyWidth);

        _this2.store.setState({
          dynamicWidth: 0,
          allColumnsWidth: (0, _utils.uniformCalcWidth)(allColumnsWidth, curBodyWidth)
        });
  ...
  _proto.componentDidUpdate = function componentDidUpdate(prevProps) {
    ...
    if (this.props.columns && prevProps.columns !== this.props.columns && (0, _utils.isColumnWidthChange)(prevProps.columns, this.props.columns)) {
      var bodyTable = this.bodyTable;
      var bodyWidth = (0, _utils.formatTableWidth)(bodyTable, this.props.scroll, this.props.expandedRowRender);
      var allColumnsWidth = this.store.getState().allColumnsWidth;
      var columns = (0, _utils.recalcWidthWhenColumnsChange)(allColumnsWidth, this.props.columns, prevProps.columns, bodyWidth);
      var newColumns = (0, _utils.uniformCalcWidth)(columns, bodyWidth);
      this.store.setState({
        dynamicWidth: 0,
  ...
  _proto.updateColumnWidths = function updateColumnWidths(columns) {
    ...
    if (oriSelection && !resetColumnsSelection) {
      var index = (0, _findIndex2["default"])(oriAllColumnsWidth, {
        key: 'selection-column'
      });
      resetColumns.splice(index, 0, oriSelection);
    }

    var allColumnsWidth = (0, _utils.resetWidthByColumnsWidth)(resetColumns, bodyWidth);
    var newColumns = (0, _utils.uniformCalcWidth)(allColumnsWidth, bodyWidth);
    this.store.setState({
      dynamicWidth: 0,
      allColumnsWidth: newColumns
    });
  ...
  _proto.renderBottomScroll = function renderBottomScroll() {
    ...
    var scrollContainerStyle = (0, _extends2["default"])({}, style, {
      bottom: bottom
    });
    ...
    var bottomScroll = /*#__PURE__*/_react["default"].createElement("div", {
  ...
  _proto.render = function render() {
    ...
    var _this$props5 = this.props,
        ...
        resetProps = (0, _objectWithoutPropertiesLoose2["default"])(_this$props5, ["prefixCls", "className", "children", "columns", "scroll", "useFixedHeader", "useStickyFixTop", "headerFixTop", "bottomScroll", "id", "style", "loading", "loadingOption", "loadingText", "size"]);

    if (this.state.columns) {
      this.columnManager.reset(columns);
    }

    var classNames = (0, _commonTools.classnames)(prefixCls, className, (_classnames = {}, _classnames[prefixCls + "-fixed-header"] = useFixedHeader || scroll && scroll.y, _classnames[prefixCls + "-scroll-position-left"] = this.scrollPosition === 'both', _classnames[prefixCls + "-scroll-position-right"] = this.scrollPosition === 'both', _classnames[prefixCls + "-scroll-position-" + this.scrollPosition] = this.scrollPosition !== 'both', _classnames[prefixCls + "-sticky-top"] = useStickyFixTop && typeof headerFixTop === 'number', _classnames));
    ...
    }, /*#__PURE__*/_react["default"].createElement(_expandableTable["default"], (0, _extends2["default"])({
      prefixCls: prefixCls
    }, resetProps, {
      columns: columns,
      columnManager: this.columnManager,
    ...
    }), hasBottomScroll && this.renderBottomScroll(), /*#__PURE__*/_react["default"].createElement(_dragLine["default"], {
      prefixCls: prefixCls,
      ref: this.saveDragLineRef
    })), loading && loadingOption && loadingOption.type === 'spinner' && /*#__PURE__*/_react["default"].createElement(_loading["default"], {

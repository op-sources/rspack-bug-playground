...
var Trigger = /*#__PURE__*/function (_PureComponent) {
  ...
  _proto.render = function render() {
    ...
    var _this$props3 = this.props,
        ...
        restProps = (0, _objectWithoutPropertiesLoose2["default"])(_this$props3, ["className", "style", "width", "disabled", "size", "options", "multiple", "expanded", "children", "allowClear", "showSearch", "prefixCls", "placeholder", "onInputChange", "inputPrefixCls", "displayRender", "displayParent", "onRemove", "onRemoveAll", "onSearch", "query", "before"]);
    ...
    var pickerCls = (0, _commonTools.classnames)(className, _config.COMPONENT_MAIN, (_classnames2 = {}, _classnames2[this.prefix('picker')] = true, _classnames2[this.prefix('picker-disabled')] = disabled, _classnames2[this.prefix('picker-show-search')] = !!showSearch, _classnames2[this.prefix('picker-multiple')] = multiple, _classnames2[this.prefix('picker-expanded')] = expanded, _classnames2[this.prefix('picker-focus')] = expanded && !!showSearch, _classnames2[_config.COMPONENT_FOCUS] = expanded && !!showSearch, _classnames2[this.prefix(size)] = size, _classnames2));

...
exports["default"] = exports.momentValue = exports.getFormat = void 0;
...
var momentValue = function momentValue(value, props) {
  return value ? (0, _moment["default"])(value, getFormat(props), true) : null;
};

exports.momentValue = momentValue;
;
var TimePicker = (_dec = (0, _context.withConfigConsumer)('time-picker'), _dec(_class = (_temp = _class2 = /*#__PURE__*/function (_PureComponent) {
  (0, _inheritsLoose2["default"])(TimePicker, _PureComponent);
  ...
  function TimePicker(props) {
    ...
    _this.getOptions = function () {
      ...
      var hourOptions = (0, _timePickerTools.generateOptions)(24, disabledHourOptions, hideDisabledOptions, hourStep);
      var minuteOptions = (0, _timePickerTools.generateOptions)(60, disabledMinuteOptions, hideDisabledOptions, minuteStep);
      var secondOptions = (0, _timePickerTools.generateOptions)(60, disabledSecondOptions, hideDisabledOptions, secondStep);
      return {
    ...
    _this.getPanelElement = function () {
      ...
      return /*#__PURE__*/_react["default"].createElement(_timePickerPanel["default"], {
  ...
  _proto.render = function render() {
    ...
    var validDefaultOpenValue = (0, _timePickerTools.toNearestValidTime)(defaultOpenValue, hourOptions, minuteOptions, secondOptions);
    var errorClass = prefixCls + "-error";
    var errorProps = {
      className: (0, _commonTools.classnames)(errorClass, errorClass + "-" + errorLocation)
    };
    var timePickerClassName = (0, _commonTools.classnames)(prefixCls, className, prefixCls + "-" + size, (_classnames = {}, _classnames[prefixCls + "-disabled"] = disabled, _classnames[prefixCls + "-open"] = open, _classnames));
    var timePickerStyle = (0, _extends2["default"])({}, popupStyle);
    ...
    var timePickerElement = /*#__PURE__*/_react["default"].createElement("span", {
      className: timePickerClassName
    }, /*#__PURE__*/_react["default"].createElement(_rcTrigger["default"], {
      prefixCls: prefixCls + "-panel",
      ...
      size: size,
      width: width
    }))), errorMessage ? /*#__PURE__*/_react["default"].createElement("div", errorProps, errorMessage) : null);
  ...
  showMinute: true,
  showSecond: true,
  disabledHours: _timePickerTools.noop,
  disabledMinutes: _timePickerTools.noop,
  disabledSeconds: _timePickerTools.noop,
  hideDisabledOptions: false,
  transitionName: 'one-transition-slide-down',
  placement: 'bottomLeft',
  onChange: _timePickerTools.noop,
  onAmPmChange: _timePickerTools.noop,
  onOpen: _timePickerTools.noop,
  onClose: _timePickerTools.noop,
  onFocus: _timePickerTools.noop,
  onBlur: _timePickerTools.noop,
  onKeyDown: _timePickerTools.noop,
  use12Hours: false,
  errorMessage: '',

...
var DrawerChild = /*#__PURE__*/function (_React$Component) {
  (0, _inheritsLoose2["default"])(DrawerChild, _React$Component);
  ...
  function DrawerChild(props) {
    ...
    _this.setLevelAndScrolling = function (open, placementName, value) {
      ...
      if (!_commonTools.windowIsUndefined) {
    ...
    _this.toggleScrollingToDrawerAndBody = function (right) {
      ...
      if (container && container.parentNode === document.body && showMask) {
        ...
        if (open && document.body.style.overflow !== 'hidden') {
          ...
          document.body.style.touchAction = ''; // 恢复事件
  ...
  _proto.componentDidMount = function componentDidMount() {
    ...
    if (!_commonTools.windowIsUndefined) {
      this.passive = _commonTools.passiveSupported ? {
        passive: false
      } : false;

      if (this.props.closeDrawerByClickBody && this.props.open) {
        window.addEventListener('click', this.handleClickBody);
      }
    }
  ...
  _proto.render = function render() {
    ...
    var _this$props6 = this.props,
        ...
        handler = _this$props6.handler,
        onChange = _this$props6.onChange,
        afterVisibleChange = _this$props6.afterVisibleChange,
        showMask = _this$props6.showMask,
        maskClosable = _this$props6.maskClosable,
        maskStyle = _this$props6.maskStyle,
        drawerStyle = _this$props6.drawerStyle,
        onClose = _this$props6.onClose,
        onHandleClick = _this$props6.onHandleClick,
        keyboard = _this$props6.keyboard,
        getOpenCount = _this$props6.getOpenCount,
        props = (0, _objectWithoutPropertiesLoose2["default"])(_this$props6, ["className", "children", "style", "width", "height", "open", "prefixCls", "placement", "level", "ease", "duration", "getContainer", "handler", "onChange", "afterVisibleChange", "showMask", "maskClosable", "maskStyle", "drawerStyle", "onClose", "onHandleClick", "keyboard", "getOpenCount"]); // 首次渲染都将是关闭状态。

    var open = this.dom ? $open : false;
    var wrapperClassName = (0, _commonTools.classnames)(prefixCls, (_classnames = {}, _classnames[prefixCls + "-" + placement] = true, _classnames[prefixCls + "-open"] = open, _classnames[className || ''] = !!className, _classnames['no-mask'] = !showMask, _classnames));
    ...
    return /*#__PURE__*/_react["default"].createElement("div", (0, _extends2["default"])({}, (0, _omit["default"])(props, ['switchScrollingEffect', 'closeDrawerByClickBody', 'scrollLocker']), {
      tabIndex: -1,
...
DrawerChild.getDerivedStateFromProps = function (props, _ref2) {

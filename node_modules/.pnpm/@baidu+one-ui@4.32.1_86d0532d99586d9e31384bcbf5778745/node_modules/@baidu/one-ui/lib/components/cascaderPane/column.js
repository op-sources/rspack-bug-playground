...
var Column = /*#__PURE__*/function (_PureComponent) {
  (0, _inheritsLoose2["default"])(Column, _PureComponent);
  ...
  function Column() {
    ...
    _this.renderGroup = function (option) {
      ...
      return /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, _this.renderOption(option, true), (expandType !== 'toggle' || expandType === 'toggle' && _this.state.expandedKeys.includes(key)) && /*#__PURE__*/_react["default"].createElement("ul", {
        key: "g-" + key,
  ...
  _proto.render = function render() {
    ...
    var className = (0, _commonTools.classnames)((_classnames = {}, _classnames[this.prefix('menu')] = true, _classnames[this.prefix('menu-fixed-width')] = width, _classnames));
    var colStyle = (0, _extends2["default"])({}, style);

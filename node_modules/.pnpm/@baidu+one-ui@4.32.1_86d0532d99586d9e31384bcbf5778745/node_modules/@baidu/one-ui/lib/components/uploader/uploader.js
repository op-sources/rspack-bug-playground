...
var defaultUploader = function defaultUploader(options) {
  ...
  return (0, _uploaderTools.fileUploader)(options);
};

var Uploader = (_dec = (0, _context.withConfigConsumer)('uploader'), _dec(_class = (_temp = _class2 = /*#__PURE__*/function (_PureComponent) {
  (0, _inheritsLoose2["default"])(Uploader, _PureComponent);
  ...
  function Uploader(props) {
    ...
    _this.getFileIndex = function (file) {
      ...
      var currentFileIndex = (0, _findIndex2["default"])(fileList, function (file) {
        return file.uid === uid;
      });
    ...
    _this.onValidatorFiles = function (files) {
      ...
      _fileList.forEach(function (file, index) {
        if (file.status === _uploaderTools.originStatus.WAITING && file.isNewUpload) {
          ...
          _fileList[index] = (0, _extends2["default"])({}, _fileList[index], {
    ...
    _this.onValidatorSingleFile = function (file) {
      ...
      (0, _map2["default"])(_uploaderTools.checkFileRules, function (checkFileRule) {
        if (checkFileRule.match({
          file: file,
          options: {
            accept: (0, _uploaderTools.getAccept)(accept, listType),
            maxSize: maxSize
          }
        })) {
    ...
    _this.onRemove = function (_ref) {
      ...
      if (curFile && curFile.status === _uploaderTools.originStatus.UPLOADING && _this.uploaderXhrMap[curFile.uid] && typeof _this.uploaderXhrMap[curFile.uid].abort === 'function') {
    ...
    (0, _warning.propChangeWarning)('Uploader', props, {
  ...
  _proto.render = function render() {
    ...
    var uploadClassNames = (0, _commonTools.classnames)(prefixCls, className, prefixCls + "-picker-position-" + pickerPosition, (_classnames = {}, _classnames[prefixCls + "-" + size] = listType !== 'file', _classnames[prefixCls + "-image"] = showType === 'image', _classnames));

    var uploadPicker = /*#__PURE__*/_react["default"].createElement(_uploaderAnchor["default"], (0, _extends2["default"])({
      key: "uploader-anchor"
    }, this.props, {
    ...
    if (showType === 'image') {
      ...
      }, /*#__PURE__*/_react["default"].createElement(_uploaderList["default"], (0, _extends2["default"])({
        key: "uploader-list"
      }, this.props, {
        fileList: fileList,
    ...
    var renders = [uploadPicker, /*#__PURE__*/_react["default"].createElement(_uploaderList["default"], (0, _extends2["default"])({
      key: "upload-list"
    }, (0, _omit["default"])(this.props, ['picker']), {
      fileList: fileList,
      onSort: this.onSort,
      onRemove: this.onRemove,
      listType: showType,
  ...
  transformFile: _identity2["default"],

...
var _ink = _interopRequireDefault(require("./ink"));
...
;
var Nav = (_dec = (0, _context.withConfigConsumer)('nav'), _dec(_class = (_temp = _class2 = /*#__PURE__*/function (_PureComponent) {
  (0, _inheritsLoose2["default"])(Nav, _PureComponent);
  ...
  function Nav(props) {
    ...
    _this.renderItem = function (item) {
      ...
      var itemClassNames = (0, _commonTools.classnames)(prefixCls + "-item", (_classnames = {}, _classnames[prefixCls + "-item-disabled"] = disabled, _classnames[prefixCls + "-item-selected"] = value === key, _classnames[prefixCls + "-item-hidden"] = itemIHideen, _classnames));

      var renderItemNode = /*#__PURE__*/_react["default"].createElement("a", {
        ...
        href: href,
        target: target,
        onMouseEnter: (0, _partial2["default"])(_this.onMouseEnterItem, index, disabled),
        onMouseLeave: _this.onMouseLeaveItem
      }, /*#__PURE__*/_react["default"].createElement("div", {
        className: prefixCls + "-item-text",
        ref: (0, _partial2["default"])(_this.getHoverItemTextRef, index)
      }, label), overlay && typeof overlay === 'object' ? /*#__PURE__*/_react["default"].createElement(_dlsIconsReact.IconChevronDown, {
      ...
      if (overlay && typeof overlay === 'object' && !itemIHideen) {
        ...
        var overlayClassName = (0, _commonTools.classnames)(prefixCls + "-overlay", className);
        return /*#__PURE__*/_react["default"].createElement(_overlay["default"], (0, _extends2["default"])({
    ...
    _this.renderOverFlowedItem = function (prefixCls) {
      ...
      var overlay = /*#__PURE__*/_react["default"].createElement("div", {
        ...
        var itemClassNames = (0, _commonTools.classnames)(prefixCls + "-item", (_classnames2 = {}, _classnames2[prefixCls + "-overflow-item-disabled"] = disabled, _classnames2[prefixCls + "-overflow-item-selected"] = value === key, _classnames2));
        ...
        var renderItemNode = /*#__PURE__*/_react["default"].createElement("a", {
          ...
          href: href,
          target: target
        }, label, overlayItem && typeof overlayItem === 'object' ? /*#__PURE__*/_react["default"].createElement(_dlsIconsReact.IconChevronRight, {
      ...
      }, /*#__PURE__*/_react["default"].createElement(_dlsIconsReact.IconEllipsis, null)));
    };

    (0, _warning["default"])(!('datasource' in props), 'The `datasource` prop of `Nav` is deprecated, use `dataSource` instead');
  ...
  _proto.render = function render() {
    ...
    var _this$props2 = this.props,
        ...
        restProps = (0, _objectWithoutPropertiesLoose2["default"])(_this$props2, ["className", "prefixCls"]);
    ...
    var navClassNames = (0, _commonTools.classnames)(prefixCls, className);
    var inkProps = {
      prefixCls: prefixCls,
      hoverIndex: this.state.hoverIndex,
      itemTextRefMap: this.itemTextRefMap
    };
    var props = (0, _omit2["default"])(restProps, ['value', 'defaultValue', 'dataSource', 'datasource', 'onChange']);
    return /*#__PURE__*/_react["default"].createElement("div", (0, _extends2["default"])({
      className: navClassNames
    }, props, {
      ref: this.navRef
    }), dataSource.map(function (item, index) {
      return _this3.renderItem((0, _extends2["default"])({}, item, {
        prefixCls: prefixCls,
        index: index
      }));
    }), /*#__PURE__*/_react["default"].createElement(_ink["default"], inkProps), this.renderOverFlowedItem(prefixCls));
  };

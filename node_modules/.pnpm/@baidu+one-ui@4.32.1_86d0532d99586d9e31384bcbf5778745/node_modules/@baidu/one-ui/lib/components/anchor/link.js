...
var AnchorLink = (_dec = (0, _context.withConfigConsumer)('anchor'), _dec(_class = (_temp = _class2 = /*#__PURE__*/function (_PureComponent) {
  (0, _inheritsLoose2["default"])(AnchorLink, _PureComponent);
  ...
  _proto.renderLink = function renderLink() {
    ...
    var wrapperClassName = (0, _commonTools.classnames)(className, prefixCls + "-link", (_classnames = {}, _classnames[prefixCls + "-link-active"] = active, _classnames[prefixCls + "-link-not-active"] = !active, _classnames[prefixCls + "-link-has-children"] = !!children, _classnames[prefixCls + "-link-without-children"] = !children, _classnames));
    var titleClassName = (0, _commonTools.classnames)(prefixCls + "-link-title", (_classnames2 = {}, _classnames2[prefixCls + "-link-title-active"] = active, _classnames2[prefixCls + "-link-title-not-active"] = !active, _classnames2));
    var label = isALabel ? /*#__PURE__*/_react["default"].createElement("a", {
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/_react["default"].createElement(_context2["default"].Consumer, null, function (context) {

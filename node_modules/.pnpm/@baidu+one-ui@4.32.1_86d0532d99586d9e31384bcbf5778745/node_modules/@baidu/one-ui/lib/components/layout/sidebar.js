...
var LayoutSidebar = (_dec = (0, _context.withConfigConsumer)('layout-sidebar'), _dec(_class = (_temp = _class2 = /*#__PURE__*/function (_PureComponent) {
  (0, _inheritsLoose2["default"])(LayoutSidebar, _PureComponent);
  ...
  _proto.renderCollapseTrigger = function renderCollapseTrigger() {
    ...
    var icon = hiddenMode ? collapsed ? _dlsIconsReact.IconChevronRight : _dlsIconsReact.IconChevronLeft : collapsed ? _dlsIconsReact.IconIndent : _dlsIconsReact.IconOutdent;
    return /*#__PURE__*/_react["default"].createElement("div", {
      className: (0, _commonTools.classnames)(prefixCls + "-toggle", (_classnames = {}, _classnames[prefixCls + "-toggle-bottom"] = !hiddenMode, _classnames[prefixCls + "-toggle-right"] = hiddenMode, _classnames))
  ...
  _proto.render = function render() {
    ...
    var _this$props3 = this.props,
        ...
        restProps = (0, _objectWithoutPropertiesLoose2["default"])(_this$props3, ["className", "prefixCls", "children", "showToggle", "collapseMode", "defaultCollapsed", "collapsed", "onCollapsedChange", "width", "style", "sticky", "autoCollapse"]);
    var styleProp;
    ...
    return /*#__PURE__*/_react["default"].createElement("aside", (0, _extends2["default"])({
      className: (0, _commonTools.classnames)(prefixCls, className, (_classnames2 = {}, _classnames2[prefixCls + "-collapsed"] = this.state.collapsed, _classnames2[prefixCls + "-mode-hidden"] = hiddenMode, _classnames2[prefixCls + "-sticky"] = sticky, _classnames2))
    }, restProps, {
      style: styleProp
  ...
  autoCollapse: false,
  showToggle: false
}, _class2.contextType = _context2["default"], _temp)) || _class);

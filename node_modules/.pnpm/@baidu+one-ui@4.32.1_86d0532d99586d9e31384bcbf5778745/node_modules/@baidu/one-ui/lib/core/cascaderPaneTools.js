...
exports.filterDisabledParentCheckedKeys = exports.formatDisabledKeys = exports.getDisabledKeys = exports.flattenMultipleTree = exports.findAncestor = exports.flattenTree = exports.filterSearchValue = exports.formatDeleteCheckedKeys = exports.formatParentKeys = exports.formatAllCheckedKeys = exports.getCancelIndeterminateKeys = exports.getIndeterminateKeys = exports.formatCheckedKeys = exports.transOptionsToObject = void 0;

var _pullAll2 = _interopRequireDefault(require("lodash/pullAll"));
...
var getIndeterminateKeys = function getIndeterminateKeys(optionsObject, targetKeys, indeterminates, checkedKeys) {
...
exports.getIndeterminateKeys = getIndeterminateKeys;

var getCancelIndeterminateKeys = function getCancelIndeterminateKeys(optionsObject, targetKeys, indeterminates, checkedKeys) {
  if (indeterminates === void 0) {
    indeterminates = [];
  }
...
exports.getCancelIndeterminateKeys = getCancelIndeterminateKeys;
...
var formatDeleteCheckedKeys = function formatDeleteCheckedKeys(optionsObject, deleteKey, interCheckedKeys) {
  ...
  return [].concat((0, _pullAll2["default"])(interCheckedKeys, deleteCheckedKeys));
}; // 获取筛选的key
...
var findAncestor = function findAncestor(optionsObject, curKey, ancestor) {
  ...
  return (0, _uniq2["default"])(ancestor);
}; // 展平多选树 - 多选的情况
...
var getDisabledKeys = function getDisabledKeys(disabledKeys, optionsObject) {
...
var formatDisabledKeys = function formatDisabledKeys(optionsObject) {
  var disabledKeys = [];
  ...
  return (0, _uniq2["default"])(getDisabledKeys(disabledKeys, optionsObject));
};

exports.formatDisabledKeys = formatDisabledKeys;

var filterDisabledParentCheckedKeys = function filterDisabledParentCheckedKeys(optionsObject, checkedKeys) {
  var removeFilters = [];
  ...
  return [].concat((0, _pullAll2["default"])(checkedKeys, removeFilters));
};

exports.filterDisabledParentCheckedKeys = filterDisabledParentCheckedKeys;
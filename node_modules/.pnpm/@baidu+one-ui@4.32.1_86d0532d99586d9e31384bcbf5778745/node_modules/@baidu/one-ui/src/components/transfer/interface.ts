...
export interface TransferProps extends BaseProps {
     ...
     * 左侧候选树展开/收起时触发
     */
    handleCandidateExpand?: (expandedKeys, {expanded, node}: {expanded: boolean, node}) => void;
     ...
     * 左侧候选树节点单个选择回调
     */
    handleSelect?: (selectedList: string[], allDataMap, expandedKeys: string[], event: {target: {key: string}}) => void;

    /**
     * 全选回调
     */
    handleSelectAll?: (selectedList: string[], allDataMap, expandedKeys: string[]) => void;

    /**
     * 右侧已选树单个删除回调
     */
    handleDelete?: (selectedList: string[], allDataMap, deleteKey: string) => void;

    /**
     * 右侧已选树全部删除回调
     */
    handleDeleteAll?: (selectedList: string[], allDataMap, expandedKeys: string[]) => void;
     ...
     */
    levelOptions?: Array<{value: string, label: ReactNode}>;
     ...
     * 自定义备选区
     */
    CustomCandidatePane?: ReactElement | ((props) => ReactElement);

    /**
     * 自定义已选区
     */
    CustomSelectedPane?: ReactElement | ((props) => ReactElement);

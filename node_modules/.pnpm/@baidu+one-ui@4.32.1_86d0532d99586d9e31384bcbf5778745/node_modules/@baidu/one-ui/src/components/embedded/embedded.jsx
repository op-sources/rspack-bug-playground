...
export default class Embedded extends PureComponent {
    ...
    renderFooter = () => {
        const {
            footer, onOk, onCancel, okProps,
            cancelProps, okOrder, cancelOrder,
            buttonSize, size, okText, cancelText,
            hideDefaultFooter
        } = this.props;
        if (footer) {
            return footer;
    ...
    render() {
        const {
            title, prefixCls, className,
            closable, children, size,
            position
        } = this.props;

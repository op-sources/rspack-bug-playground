...
export type UploaderListType = 'file' | 'image' | 'video' | 'media';
...
export type UploadImageDefaultAction = 'delete' | 'preview' | 'reUpload' | string;
export type UploadFileDefaultAction = 'delete' | string;

export type UploadBaseActionItem = {
    /**
     * key
     */
    key: string;
...
export type UploadImageActionItem = UploadBaseActionItem & {
    /**
     * key
     */
     ...
     * 子选项
     */
    children?: Array<UploadImageActionItem & {label: ReactNode}>;
}

export type UploadFileActionItem = UploadBaseActionItem & {
    /**
     * key
     */
     ...
     * 点击
     */
    onClick?: (file: UploadFile, event) => void;
}

export type UploadEntryActionItem = UploadBaseActionItem & {
    /**
     * 标签
     */
    label: ReactNode;
...
export type UploadActionsProducer<T> = (file: UploadFile, defaultActions: T[]) => T[];


/**
 * 卡片底部操作图标配置
 */
export type UploadOperationListIcon = {
 ...
 * 多入口属性
 */
export type UploaderMultipleAnchorProps = UploaderImageAnchorProps;

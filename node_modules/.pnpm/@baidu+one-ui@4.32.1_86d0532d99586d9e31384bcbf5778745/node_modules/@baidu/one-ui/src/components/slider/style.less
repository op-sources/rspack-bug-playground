...
.slider-size(@size, @track-height, @border-radius, @dot-height, @font-size, @thumb-height, @track-width) {
...
.slider-size(small, @dls-slider-track-width-s, @dls-slider-track-border-radius-s, @dls-slider-mark-size-s, @dls-slider-font-size-s, @dls-slider-thumb-size-s, @dls-slider-track-width-s);
.slider-size(medium, @dls-slider-track-width-m, @dls-slider-track-border-radius-m, @dls-slider-mark-size-m, @dls-slider-font-size-m, @dls-slider-thumb-size-m, @dls-slider-track-width-m);
...
.@{slider-prefix-cls}.@{slider-prefix-cls}-readOnly {
    ...
    .@{slider-prefix-cls}-handle {
        ...
        &-click-focused {
            ...
            box-shadow: @dls-slider-thumb-shadow-read-only-focus;
        }
    }
    .@{slider-prefix-cls}-dot {
        background-color: @dls-slider-track-color-read-only;
...
.@{slider-prefix-cls}.@{slider-prefix-cls}-disabled {
    .@{slider-prefix-cls}-mark-text {
...
.vertical() {
    &-vertical {
        width: @slider-height;
        height: 100%;
        margin: @dls-padding-unit @dls-padding-unit * 2;
        padding: 0 @dls-padding-unit;

        .@{slider-prefix-cls}-rail {
            width: @dls-padding-unit;
            height: 100%;
        }

...
@dls-tooltip-shadow-normal: 0 1px 4px rgba(0, 0, 0, 0.15);

.tooltip-style(light, @dls-tooltip-background-color-normal, @dls-tooltip-shadow-normal, @dls-tooltip-font-color-normal);
.tooltip-style(dark, @dls-tooltip-background-color-reverse, @dls-tooltip-shadow-reverse, @dls-tooltip-font-color-reverse);
...
// .@{tooltip-prefix-cls}-dark > .@{tooltip-prefix-cls}-content >  .@{tooltip-prefix-cls}-inner {

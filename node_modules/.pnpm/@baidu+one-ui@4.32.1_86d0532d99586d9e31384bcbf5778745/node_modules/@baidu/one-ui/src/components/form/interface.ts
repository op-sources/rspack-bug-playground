...
export interface FormProps extends BasePropsWithChildren,
     ...
     * 表单变化回调，包括error
     */
    onFieldsChange?(formProps: FormProps, changedFields: {[key: string]: any}, allFields: {[key: string]: any}): void;

    /**
     * 表单值变化回调
     */
    onValuesChange?(formProps: FormProps, changedValues: {[key: string]: any}, allValues: {[key: string]: any}): void;
     ...
     * 属性与field映射
     */
    mapPropsToFields?(props: FormProps): {[key: string]: FormField};
     ...
     */
    onFinishFailed?: (
        errors: Record<string, {errors: Array<{field: string, message: ReactNode | ReactNode[]}>}>,
...
export interface FormFieldGroupProps extends BasePropsWithChildren,
...
export interface FormFieldOption {
     ...
     * @internal
     */
    validate?: {trigger?: string | string[], rules?: FormFieldRule[]}[],

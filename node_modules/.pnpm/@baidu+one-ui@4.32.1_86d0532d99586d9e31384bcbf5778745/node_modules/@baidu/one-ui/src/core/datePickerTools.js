...
export const getTimeStamp = date => {
    ...
    const dateTimesTamp = dayjs(date).toDate();
...
export const formatMultipleDate = (value, dateFormat) => {
    ...
    return {
        beginDate: beginDate ? dayjs(beginDate).format(dateFormat) : beginDate,
        endDate: endDate ? dayjs(endDate).format(dateFormat) : endDate
    };
};

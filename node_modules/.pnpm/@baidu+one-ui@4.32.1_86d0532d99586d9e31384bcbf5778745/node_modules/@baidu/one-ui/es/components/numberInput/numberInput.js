...
var NumberInput = (_dec = withConfigConsumer('number-input'), _dec(_class = (_temp = _class2 = /*#__PURE__*/function (_PureComponent) {
  ...
  _proto.render = function render() {
    ...
    var mainProps = {
      className: classnames(mainClass, (_classnames = {}, _classnames[COMPONENT_MAIN] = mode === 'strong', _classnames[COMPONENT_FOCUS] = mode === 'strong' && hasFocus, _classnames))
    };
    var addonClass = mainClass + "-addon";
    var containerProps = {
      className: classnames(prefixCls, (_classnames2 = {}, _classnames2[COMPONENT_MAIN] = mode !== 'strong', _classnames2[prefixCls + "-focus"] = hasFocus, _classnames2[COMPONENT_FOCUS] = mode !== 'strong' && hasFocus, _classnames2[prefixCls + "-disabled"] = disabled, _classnames2[prefixCls + "-readonly"] = readOnly, _classnames2[prefixCls + "-with-spin"] = showSpinButtons, _classnames2)),
      style: {
        width: width
      }
    };

...
var RangePicker = (_dec = withConfigConsumer('date-picker'), _dec(_class = (_temp = _class2 = /*#__PURE__*/function (_PureComponent) {
  ...
  function RangePicker(props) {
    ...
    _this.renderMultipleDatePickerBody = function () {
      ...
      var datePickerContainerClassName = classnames(prefixCls + "-panel", prefixCls + "-multiple", prefixCls + "-panel-" + size);
      ...
      })) : null, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(Input, _extends({}, _this.props, {
        visible: visible,
        onChange: _this.onSelectDay,
        multiple: true
  ...
  _proto.render = function render() {
    ...
    var layerProps = {
      ...
      popupClassName: classnames(prefixCls + "-overlay", prefixCls + "-overlay-" + size, (_classnames2 = {}, _classnames2[prefixCls + "-overlay-has-shortcuts"] = shortcuts && shortcuts.length, _classnames2)),

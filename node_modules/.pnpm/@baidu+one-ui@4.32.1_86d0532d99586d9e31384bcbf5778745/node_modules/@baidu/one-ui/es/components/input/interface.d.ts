...
export interface InputProps extends BaseProps, Omit<JSX.IntrinsicElements['input'], 'ref' | 'size' | 'onChange' | 'prefix'> {
    /**
     * 默认值
     */
    defaultValue?: string;
...
export declare type InputGroupProps = BasePropsWithChildren;

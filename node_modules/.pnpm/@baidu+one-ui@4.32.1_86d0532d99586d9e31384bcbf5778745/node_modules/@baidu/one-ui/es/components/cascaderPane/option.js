...
var Option = /*#__PURE__*/function (_PureComponent) {
  ...
  _proto.render = function render() {
    ...
    var className = classnames((_classnames = {}, _classnames[this.prefix('menu-item')] = true, _classnames[this.prefix('menu-item-group-title')] = group, _classnames[this.prefix('menu-item-expand')] = hasChildren, _classnames[this.prefix('menu-item-active')] = active, _classnames[this.prefix('menu-item-selected')] = selected, _classnames[this.prefix('menu-item-disabled')] = disabled, _classnames[this.prefix('menu-item-unselectable')] = selectable === false, _classnames[this.prefix('menu-item-loading')] = loading, _classnames));
    var hover = hasChildren && !disabled && expandTrigger === 'hover';
    var node = /*#__PURE__*/React.createElement("li", {
      className: className,
      title: title,
      onClick: this.handleOnSelect,
      onMouseEnter: hover ? this.handleMouseEnter : null,
      onMouseLeave: hover ? this.handleMouseLeave : null
    }, expandType === 'toggle' && this.renderExpandIcon(), showCheckbox && selectable !== false && /*#__PURE__*/React.createElement(Checkbox, {
      checked: checked,
  ...
  _proto.renderExpandIcon = function renderExpandIcon() {
    ...
    return /*#__PURE__*/React.createElement("span", {
      className: classNames(this.prefix('menu-item-expand-icon'), (_classNames = {}, _classNames[this.prefix('menu-item-expand-icon-toggle')] = expandType === 'toggle', _classNames[this.prefix('menu-item-expanded')] = expandType === 'toggle' && expanded, _classNames))
    }, expandType === 'toggle' ? /*#__PURE__*/React.createElement(IconCaretRight, {
...
export function EmptyOption(_ref) {

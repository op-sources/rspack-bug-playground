...
import { addEventListener, dataToArray, getTouchParentScroll, removeEventListener, transitionEnd, isNumeric } from '../../../core/drawerTools';
import { classnames, windowIsUndefined, passiveSupported } from '../../../core/commonTools';
var currentDrawer = {};
;
...
var DrawerChild = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    var _this$props6 = this.props,
        ...
        props = _objectWithoutPropertiesLoose(_this$props6, ["className", "children", "style", "width", "height", "open", "prefixCls", "placement", "level", "ease", "duration", "getContainer", "handler", "onChange", "afterVisibleChange", "showMask", "maskClosable", "maskStyle", "drawerStyle", "onClose", "onHandleClick", "keyboard", "getOpenCount"]); // 首次渲染都将是关闭状态。
    ...
    return /*#__PURE__*/React.createElement("div", _extends({}, omit(props, ['switchScrollingEffect', 'closeDrawerByClickBody', 'scrollLocker']), {
      tabIndex: -1,

...
import { flattenTreeData, convertDataToTree } from './utils';
import { convertTreeToEntities, getDataAndAria, getPosition, parseCheckedKeys, conductExpandParent, calcSelectedKeys, arrAdd, arrDel, conductCheck, warnOnlyTreeNode } from '../../../core/treeTools';
import Context from './context';

var VirtualTree = /*#__PURE__*/function (_React$Component) {
  _inheritsLoose(VirtualTree, _React$Component);
  ...
  function VirtualTree() {
    ...
    _this.onNodeExpand = function (e, treeNode) {
      ...
      var flattenNodes = flattenTreeData(_this.state.treeNode, expandedKeys);
  ...
  VirtualTree.getDerivedStateFromProps = function getDerivedStateFromProps(props, prevState) {
    ...
    if (treeNode || newState.expandedKeys) {
      var flattenNodes = flattenTreeData(treeNode, newState.expandedKeys || prevState.expandedKeys);

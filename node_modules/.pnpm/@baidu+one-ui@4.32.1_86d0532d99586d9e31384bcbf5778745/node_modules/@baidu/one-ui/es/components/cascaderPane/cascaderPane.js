...
var CascaderPane = /*#__PURE__*/function (_PureComponent) {
  ...
  CascaderPane.getDerivedStateFromProps = function getDerivedStateFromProps(props, state) {
    ...
    if (!_isEqual(options, state.optionsClone) || showCheckbox !== state.showCheckbox || changeOnSelect !== state.changeOnSelect) {
      newState.optionsClone = _cloneDeepWith(options, function (value) {
    ...
    if ('checkedKeys' in props && (!shallowEqual(checkedKeys, state.checkedKeys) || tree && !shallowEqual(checkedKeys, tree.checkedKeys))) {
      newState.checkedKeys = checkedKeys;
      buildTree = true;
    }

    if (buildTree) {
      tree = new Tree(options, checkedKeys || state.checkedKeys, fieldNames, !showCheckbox && !changeOnSelect);
      newState.tree = tree;
    }
    ...
    if (buildTree || buildColumns) {
      newState.columns = tree.getColumns(_last(activeValue), activeValue, showCheckAll, firstColumnGroup === true);
    }
  ...
  _proto.render = function render() {
    ...
    var paneClassName = classnames(className, prefixCls, this.prefix(size), (_classnames = {}, _classnames[this.prefix('show-search')] = showSearch, _classnames[this.prefix('multiple')] = showCheckbox, _classnames));
  ...
  _proto.renderMenu = function renderMenu() {
    ...
    if (columns.length === 0 || query && useDefaultFilter) {
      return /*#__PURE__*/React.createElement(SearchMenu, {
        prefixCls: prefixCls,
  ...
  _proto.componentDidUpdate = function componentDidUpdate(preProps) {
    ...
    if (!preProps.visible || _isEmpty(preProps.value) && !_isEmpty(value) || _isEmpty(preProps.options) && !_isEmpty(options)) {
      this.scrollActiveItemToView();
    }
  };
  ...
  _proto.renderSearch = function renderSearch() {
    ...
    return /*#__PURE__*/React.createElement(CascaderInput, props);
  };
  ...
  _proto.loadData = function loadData(option, trigger, scope) {
    ...
    if (loadData && isLeaf === false && !children) {
      ...
      if (promise && promise["finally"]) {
        ...
        loadingMap[key] = true;
        this.setState({
          loadingMap: _extends({}, loadingMap, (_extends2 = {}, _extends2[key] = true, _extends2))
        });
        promise["finally"](function () {
          _this3.setState({
            loadingMap: _omit(_this3.state.loadingMap, [key])
          });
        });
      }
    }
...
CascaderPane.defaultProps = {
  ...
  expandIcon: /*#__PURE__*/React.createElement(IconChevronRight, null),
  loadingIcon: /*#__PURE__*/React.createElement(IconLoading, {
    size: "small"
  }),
  showCheckbox: false,

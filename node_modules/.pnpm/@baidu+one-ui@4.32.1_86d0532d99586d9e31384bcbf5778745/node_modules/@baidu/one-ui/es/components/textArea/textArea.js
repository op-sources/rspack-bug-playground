...
var TextArea = (_dec = withConfigConsumer('textarea'), _dec(_class = (_temp = _class2 = /*#__PURE__*/function (_PureComponent) {
  ...
  _proto.render = function render() {
    ...
    var otherProps = omit(props, ['prefixCls', 'maxRows', 'minRows', 'filterArray', 'defaultValue', 'showErrorWithoutErrorMessage', 'showErrorMessage', 'originTextAreaProps', 'containerRef', 'width'].concat(commonRemoveProps, locationRemoveProps));
    ...
    var defaultProps = _extends({
      ...
      className: classnames(prefixCls, className, COMPONENT_MAIN, (_classnames = {}, _classnames[prefixCls + "-disabled"] = disabled, _classnames[prefixCls + "-readOnly"] = readOnly, _classnames)),

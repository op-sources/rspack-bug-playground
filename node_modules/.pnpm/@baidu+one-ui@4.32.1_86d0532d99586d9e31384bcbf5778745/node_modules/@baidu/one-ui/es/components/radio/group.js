...
;
var RadioGroup = (_dec = withConfigConsumer('radio-group'), _dec(_class = (_temp = _class2 = /*#__PURE__*/function (_PureComponent) {
  ...
  _proto.render = function render() {
    ...
    var classString = classnames(prefixCls, (_classnames = {}, _classnames[prefixCls + "-" + size] = size, _classnames[prefixCls + "-" + type] = type, _classnames[prefixCls + "-" + direction] = direction, _classnames), className);
    var Item = Radio;
  ...
  if ('value' in nextProps) {
    ...
    var checkedValue = getCheckedValue(children)[0];

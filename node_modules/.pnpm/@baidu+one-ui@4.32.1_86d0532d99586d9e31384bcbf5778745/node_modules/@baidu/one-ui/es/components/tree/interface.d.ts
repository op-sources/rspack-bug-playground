...
export interface TreeProps extends BasePropsWithChildren {
     ...
     * 加载数据
     */
    loadData?: (node: any, key: string, type: 'check' | 'expand' | 'select') => Promise<void>;
    /**
     * load完毕回调
     */
     ...
     * 切换Icon
     */
    switcherIcon?: ReactElement | ((option: {
        isLeaf: boolean;
        loading: boolean;
    }) => ReactElement);
    /**
     ...
     * 点击
     */
    onClick?: (e: any, treeNode: any) => void;
    /**
     * 双击
     */
    onDoubleClick?: (e: any, treeNode: any) => void;
    /**
     * MouseEnter
     */
    onMouseEnter?: (data: {

...
import { classnames, handleCountTips, CHINA_COUNT_MODE, getRealLength, handleEventParams } from '../../core/commonTools';
...
;
var Input = (_dec = withConfigConsumer('input'), _dec(_class = (_temp = _class2 = /*#__PURE__*/function (_PureComponent) {
  ...
  function Input(_props) {
    ...
    _this.validateLength = function () {
      ...
      var props = _this.props;
      return value && value.length && (isMaxLenError(_extends({}, props, {
        value: value
  ...
  _proto.getInputClassName = function getInputClassName() {
    ...
    return classnames(prefixCls, (_classnames = {}, _classnames[COMPONENT_MAIN] = !(prefix || suffix), _classnames[prefixCls + "-focus"] = !(prefix || suffix) && this.state.hasFocus, _classnames[prefixCls + "-" + size] = size, _classnames[prefixCls + "-disabled"] = disabled, _classnames[prefixCls + "-readOnly"] = readOnly, _classnames));
  };
  ...
  _proto.renderInnerSuffix = function renderInnerSuffix() {
    ...
    var operationClassName = classnames(prefixCls + "-operation", (_classnames2 = {}, _classnames2[prefixCls + "-operation-error"] = this.validateLength(), _classnames2));
    return showClear && value && value.length || maxLen != null ? /*#__PURE__*/React.createElement("span", {
      className: operationClassName,
      ref: this.saveRef('inputCountAnchor')
    }, this.renderClearIcon(), maxLen != null ? /*#__PURE__*/React.createElement("span", {
      className: prefixCls + "-count"
    }, handleCountTips(getRealLength(this.props, value), maxLen)) : null) : null;
  };
  ...
  _proto.renderLabeledIcon = function renderLabeledIcon(children) {
    ...
    var inputContent = /*#__PURE__*/React.createElement("div", {
    ...
    var prefixItem = prefix ? /*#__PURE__*/React.createElement("span", {
      className: prefixCls + "-prefix"
    }, prefix) : null;
    var suffixItem = suffix ? /*#__PURE__*/React.createElement("span", {
      className: prefixCls + "-suffix"
    }, suffix) : null;
    var wrapperClassName = classnames(className, COMPONENT_MAIN, prefixCls + "-affix-wrapper", (_classnames3 = {}, _classnames3[prefixCls + "-affix-wrapper-has-prefix"] = !!prefix, _classnames3[prefixCls + "-affix-wrapper-has-suffix"] = !!suffix, _classnames3[prefixCls + "-affix-wrapper-disabled"] = disabled, _classnames3['one-input-focus'] = this.state.hasFocus, _classnames3));
  ...
  _proto.renderInput = function renderInput() {
    ...
    var otherProps = omit(props, ['prefixCls', 'onPressEnter', 'addonBefore', 'addonAfter', 'prefix', 'suffix', 'defaultValue', 'originInputProps', 'showClear', 'onClear'].concat(commonRemoveProps, ['filterArray', 'isErrorHTML', 'showErrorMessage', 'inputRef']));
    ...
    return this.renderLabeledIcon( /*#__PURE__*/React.createElement("input", _extends({}, otherProps, props.originInputProps, {
      "data-type": "input",
  ...
  _proto.renderLabeledInput = function renderLabeledInput(children) {
    ...
    var addonBeforeItem = addonBefore ? /*#__PURE__*/React.createElement("span", {
      className: classnames(addonClassName, addonClassName + "-before"),
      ref: this.saveRef('addonBeforeRef')
    }, addonBefore) : null;
    var addonAfterItem = addonAfter ? /*#__PURE__*/React.createElement("span", {
      className: classnames(addonClassName, addonClassName + "-after"),
      ref: this.saveRef('addonAfterRef')
    }, addonAfter) : null;
    var className = classnames(prefixCls + "-wrapper", (_classnames4 = {}, _classnames4[wrapperClassName] = addonBeforeItem || addonAfterItem, _classnames4));
    ...
    if (addonBeforeItem || addonAfterItem) {
      return /*#__PURE__*/React.createElement("span", {
        ...
        className: className
      }, addonBeforeItem, /*#__PURE__*/cloneElement(children, {
        style: null
      }), addonAfterItem));
    }
  ...
  _proto.renderClearIcon = function renderClearIcon() {
    ...
    if (showClear && value && value.length && !disabled && !readOnly) {
      ...
      var className = classnames(prefixCls + "-clear-icon", (_classnames5 = {}, _classnames5[prefixCls + "-clear-icon-has-count"] = maxLen !== null, _classnames5));
      return /*#__PURE__*/React.createElement(IconTimesCircle, {
        className: className,
  ...
  _proto.render = function render() {
    ...
    var containerProps = {
      className: classnames(className, containerClass, containerClass + "-" + size, containerClass + "-" + type, (_classnames6 = {}, _classnames6[containerClass + "-error"] = errorMessage, _classnames6[containerClass + "-has-focused"] = hasFocus, _classnames6[COMPONENT_FOCUS] = hasFocus, _classnames6[containerClass + "-has-suffix"] = !!suffix, _classnames6[containerClass + "-has-prefix"] = !!prefix, _classnames6[containerClass + "-error-bottom"] = errorLocation === 'bottom', _classnames6)),
    ...
    var errorRender = isErrorHTML ? /*#__PURE__*/React.createElement("div", _extends({}, errorProps, {
      /* eslint-disable react/no-danger */
      dangerouslySetInnerHTML: {
        __html: errorMessage
      }
    })) : /*#__PURE__*/React.createElement("div", errorProps, errorMessage);
    var input = /*#__PURE__*/React.createElement("div", detailProps, this.renderLabeledInput(this.renderInput()));

    if (errorLocation === 'layer') {
      input = /*#__PURE__*/React.createElement(Popover, {
    ...
    return /*#__PURE__*/React.createElement("div", containerProps, input, errorLocation !== 'layer' && showErrorMessage ? errorRender : null);
  };

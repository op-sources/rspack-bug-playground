...
;
var Lightbox = (_dec = withConfigConsumer('lightbox'), _dec(_class = (_temp = _class2 = /*#__PURE__*/function (_PureComponent) {
  _inheritsLoose(Lightbox, _PureComponent);
  ...
  function Lightbox(props) {
    ...
    _this.renderCarousel = function () {
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        return /*#__PURE__*/React.createElement("div", {
          ...
          src: "" + item.src,
          controls: true
        }) : null, item.type === 'custom' ? item.src : null), item.desc ? /*#__PURE__*/React.createElement("div", {
          className: prefixCls + "-carousel-desc"
        }, /*#__PURE__*/React.createElement("span", null, item.desc)) : null));
      }));
    };
    ...
    _this.renderPrevPage = function () {
      ...
      var currentButtonProps = {
        className: classnames(prefixCls + "-page-change", prefixCls + "-page-prev", (_classnames2 = {}, _classnames2[prefixCls + "-page-change-hide"] = mode === 'normal' && _this.state.slide === 1, _classnames2)),
        type: 'translucent',
    ...
    _this.renderNextPage = function () {
      ...
      var currentButtonProps = {
        className: classnames(prefixCls + "-page-change", prefixCls + "-page-next", (_classnames3 = {}, _classnames3[prefixCls + "-page-change-hide"] = mode === 'normal' && _this.state.slide === _this.getDataSource().length, _classnames3)),
        type: 'translucent',
  ...
  _proto.render = function render() {
    ...
    var wrapperClassName = classnames(prefixCls, prefixCls + "-wrapper", className);
    return /*#__PURE__*/React.createElement(Dialog, {
      ...
      className: classnames(prefixCls + "-head", (_classnames4 = {}, _classnames4[prefixCls + "-head-hide"] = indicator === 'none' || dataSource.length === 1, _classnames4))
      ...
      className: classnames(prefixCls + "-container", (_classnames5 = {}, _classnames5[prefixCls + "-indicator-hide"] = indicator === 'none' || dataSource.length === 1, _classnames5))
    }, /*#__PURE__*/React.createElement("div", {
      className: prefixCls + "-content"
    }, this.renderPrevPage(), /*#__PURE__*/React.createElement("div", {

...
var OneSelect = /*#__PURE__*/function (_PureComponent) {
  ...
  function OneSelect(_props) {
    ...
    _this.componentDidUpdate = function (prevProps, prevState) {
      if (isMultipleOrTags(_this.props)) {
        ...
        if (!_isEqual(_this.state.value, prevState.value)) {
    ...
    _this.getValueByInput = function (string) {
      ...
      splitBySeparators(string, tokenSeparators).forEach(function (label) {
        ...
        if (multiple) {
          ...
          if (_value2 && findIndexInValueBySingleValue(nextValue, _value2) === -1) {
      ...
      React.Children.forEach(children, function (child) {
        ...
        if (_this.filterOption(inputValue, child)) {
          ...
          if ((tags || multiple // 兼容原Option包含 CheckboxText 逻辑（包含时，则原样输出）
            ...
            childNode = /*#__PURE__*/React.createElement("span", null, exclusive ? null : /*#__PURE__*/React.createElement(Checkbox, {
              checked: checked,
              prefixCls: checkboxPrefixCls,
              disabled: disabled
            }), childNode);
  ...
  _proto.render = function render() {
    ...
    }), inputIcon || /*#__PURE__*/React.createElement(IconChevronDown, null)), multiple ? this.renderTotalDom() : null);

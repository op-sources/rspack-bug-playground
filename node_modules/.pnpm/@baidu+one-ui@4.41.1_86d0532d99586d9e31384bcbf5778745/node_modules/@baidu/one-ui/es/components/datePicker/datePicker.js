...
var DatePicker = (_dec = withConfigConsumer('date-picker'), _dec(_class = (_temp = _class2 = /*#__PURE__*/function (_PureComponent) {
  ...
  function DatePicker(props) {
    ...
    _this.renderDatePickerBody = function () {
      ...
      var datePickerPanelClassName = classnames(prefixCls + "-panel", prefixCls + "-panel-" + size, hideInput && prefixCls + "-panel-hide-input");
      return /*#__PURE__*/React.createElement(Provider, {
        store: _this.store
      }, /*#__PURE__*/React.createElement("div", {
        className: datePickerPanelClassName
      }, !hideInput && /*#__PURE__*/React.createElement(Input, _extends({}, _this.props, {
        visible: visible,
  ...
  _proto.render = function render() {
    ...
    var layerProps = _extends({
      ...
      popupClassName: classnames(prefixCls + "-overlay", !hideInput && prefixCls + "-overlay-" + size)
    }, hideInput ? {} : {
      align: align
    });

...
export interface CascaderProps extends BasePropsWithChildren {
     ...
     * 定制回填区域显示的选项
     */
    displayOptions?: (selectedOptions: CascaderOption[]) => CascaderOption[];
    /**
     * 自定义浮层类名
     */
    ...
    showSearch?: boolean | {
        ...
        sort?: (a: CascaderOption[], b: CascaderOption[], query: string, fieldNames?: CascaderOptionFieldNames) => number;
    };
    /**
     * 搜索没有内容的时候
     */

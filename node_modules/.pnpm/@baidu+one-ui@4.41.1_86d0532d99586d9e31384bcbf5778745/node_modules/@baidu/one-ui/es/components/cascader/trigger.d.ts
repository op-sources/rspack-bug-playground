...
declare type CascaderTriggerProps = BaseProps & Pick<CascaderProps, 'width' | 'disabled' | 'size' | 'options' | 'multiple' | 'placeholder' | 'before' | 'allowClear' | 'showSearch' | 'onInputChange' | 'inputPrefixCls' | 'displayRender' | 'displayParent' | 'mergeChecked' | 'displayOptions'> & {
    expanded: boolean;

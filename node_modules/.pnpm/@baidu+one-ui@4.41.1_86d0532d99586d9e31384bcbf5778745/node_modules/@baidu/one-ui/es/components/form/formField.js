...
var FormField = (_dec = withConfigConsumer('form'), _dec(_class = (_temp = _class2 = /*#__PURE__*/function (_PureComponent) {
  ...
  _proto.componentDidUpdate = function componentDidUpdate(prevProps) {
    if (!_isEqual(prevProps.rules, this.props.rules)) {
  ...
  _proto.renderFieldNode = function renderFieldNode() {
    ...
    if (name && form && /*#__PURE__*/React.isValidElement(children)) {
      ...
      var normalizeFill = _isNil(fillWidth) ? this.formContext.fillWidth : fillWidth;
      fieldNode = /*#__PURE__*/React.cloneElement(children, {
        className: classnames(children.props.className, (_classnames = {}, _classnames[COMPONENT_INVALID(lightPrefix)] = validateStatus === 'error' || !_isEmpty(form.getFieldError(name)), _classnames)),
        // @ts-ignore
        width: _isNil(children.props.width) ? normalizeFill ? '100%' : undefined : children.props.width
      });
      var options = {
        rules: rules,
  ...
  _proto.renderMessages = function renderMessages(helpNode) {
    ...
    return flattenMessages.length ? /*#__PURE__*/React.createElement("div", {
      ...
      if (message.type === 'validating') {
        return typeof message.content === 'string' ? /*#__PURE__*/React.createElement(Loading, {
          key: index,
          size: "small",
          tip: message.content
        }) : message.content;
  ...
  _proto.renderField = function renderField(formContext) {
    ...
    var normalizeFillAvailable = _isNil(fillWidth) ? formContext.fillWidth : fillWidth;
    return /*#__PURE__*/React.createElement("div", {
      className: classnames(className, this.className(), (_classnames2 = {}, _classnames2[this.className('fill')] = normalizeFillAvailable, _classnames2[this.className('abstract')] = _abstract4, _classnames2[this.className('actions')] = actions, _classnames2[this.className('standalone')] = display === 'standalone', _classnames2)),
      style: style
  ...
  _proto.renderLabel = function renderLabel(helpNode) {
    ...
    if (label != null && !_abstract5) {
      ...
      return /*#__PURE__*/React.createElement("div", {
        className: classnames(this.className('label'), (_classnames3 = {}, _classnames3[this.className('label-left')] = labelAlign === 'left', _classnames3[this.className('label-required')] = required, _classnames3[this.className('label-align-help')] = help && labelPosition === 'side' && helpPosition === 'top', _classnames3))
  ...
  validateFirst: true
}, _class2.contextType = FormFieldContext, _temp)) || _class);

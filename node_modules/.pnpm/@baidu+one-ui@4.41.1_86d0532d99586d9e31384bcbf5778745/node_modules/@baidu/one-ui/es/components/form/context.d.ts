...
export interface FormContextProps extends Pick<FormProps, 'wrapperCol' | 'labelAlign' | 'labelCol' | 'colon' | 'size' | 'labelPosition' | 'fillWidth'> {
    vertical?: boolean;
    form?: {
        ...
        setFieldAsDirty: (name: string) => void;

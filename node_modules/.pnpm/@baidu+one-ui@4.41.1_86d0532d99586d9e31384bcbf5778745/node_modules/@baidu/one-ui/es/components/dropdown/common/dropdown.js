...
var Dropdown = /*#__PURE__*/function (_PureComponent) {
  ...
  function Dropdown(props) {
    ...
    _this.onClick = function (e) {
      ...
      if (! /*#__PURE__*/isValidElement(overlay)) {
        return;
      }
    ...
    _this.getMenuElement = function () {
      ...
      return /*#__PURE__*/React.cloneElement(overlay, extraOverlayProps);
    };
  ...
  _proto.getPopup = function getPopup() {
    return /*#__PURE__*/React.createElement(React.Fragment, null, this.renderTitle(), this.getMenuElement(), this.renderFooter());
  };
  ...
  _proto.renderFooter = function renderFooter() {
    ...
    if (showConfirm) {
      content = /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Button, _extends({
        size: size,
        type: "text-strong"
      }, okProps, {
  ...
  _proto.render = function render() {
    ...
    var _this$props5 = this.props,
        ...
        otherProps = _objectWithoutPropertiesLoose(_this$props5, ["prefixCls", "children", "transitionName", "placement", "getPopupContainer", "overlayClassName", "overlayStyle", "trigger", "size", "transparent"]);

    var triggerProps = omit(otherProps, ['dropdownIndependentWidth', 'title', 'showConfirm', 'onOk', 'okText', 'okProps', 'onCancel', 'cancelText', 'cancelProps']);
    ...
    return /*#__PURE__*/React.createElement(Trigger, _extends({}, triggerProps, {
      prefixCls: prefixCls,
      ref: this.saveTrigger,
      popupClassName: classNames(prefixCls + "-" + size, overlayClassName, (_classNames = {}, _classNames[prefixCls + "-transparent"] = transparent, _classNames)),
      popupAlign: {
        ignoreShake: true
      },

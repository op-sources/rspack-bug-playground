...
var Message = (_dec = withConfigConsumer('message'), _dec(_class = (_temp = _class2 = /*#__PURE__*/function (_PureComponent) {
  ...
  _proto.renderRoot = function renderRoot(iconNode, contentNode) {
    var _this$props = this.props,
        ...
        resetProps = _objectWithoutPropertiesLoose(_this$props, ["prefixCls", "className", "type", "size", "display", "children", "icon", "lightPrefix"]);

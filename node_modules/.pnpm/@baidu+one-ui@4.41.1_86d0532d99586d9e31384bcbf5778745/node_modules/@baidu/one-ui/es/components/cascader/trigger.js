...
var Trigger = (_dec = withConfigConsumer('cascader'), _dec(_class = (_temp = /*#__PURE__*/function (_PureComponent) {
  ...
  _proto.render = function render() {
    ...
    var _this$props3 = this.props,
        ...
        restProps = _objectWithoutPropertiesLoose(_this$props3, ["className", "style", "width", "disabled", "size", "options", "multiple", "expanded", "children", "allowClear", "showSearch", "prefixCls", "placeholder", "onInputChange", "inputPrefixCls", "displayRender", "displayParent", "onRemove", "onRemoveAll", "onSearch", "query", "before", "lightPrefix"]);
    ...
    var pickerCls = classnames(className, COMPONENT_MAIN(lightPrefix), (_classnames2 = {}, _classnames2[this.prefix('picker')] = true, _classnames2[this.prefix('picker-disabled')] = disabled, _classnames2[this.prefix('picker-show-search')] = !!showSearch, _classnames2[this.prefix('picker-multiple')] = multiple, _classnames2[this.prefix('picker-expanded')] = expanded, _classnames2[this.prefix('picker-focus')] = expanded && !!showSearch, _classnames2[COMPONENT_FOCUS(lightPrefix)] = expanded && !!showSearch, _classnames2[this.prefix(size)] = size, _classnames2));
  ...
  _proto.renderResults = function renderResults() {
    ...
    return normalizedOptions.map(function (option) {
      ...
      }, label), deletable !== false && /*#__PURE__*/React.createElement(Button, {
        type: "text-aux",

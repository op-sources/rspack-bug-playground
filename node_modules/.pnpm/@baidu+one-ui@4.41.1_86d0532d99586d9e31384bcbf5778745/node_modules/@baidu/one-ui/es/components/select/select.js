...
var Select = (_dec = withConfigConsumer('select'), _dec(_class = (_temp = _class2 = /*#__PURE__*/function (_PureComponent) {
  ...
  _proto.render = function render() {
    ...
    var prefixCls = props.prefixCls,
        ...
        restProps = _objectWithoutPropertiesLoose(props, ["prefixCls", "className", "mode", "onChange", "width", "style", "multipleRenderTargetMode", "dropdownClassName", "customRenderTarget", "defaultVisible", "visible", "open", "suffixIcon", "showSearch", "lightPrefix", "checkboxPrefixCls"]);
    ...
    var selectCls = classnames(prefixCls + "-" + size, COMPONENT_MAIN(lightPrefix), (_classnames = {}, _classnames[prefixCls + "-error-line"] = errorMessage, _classnames));

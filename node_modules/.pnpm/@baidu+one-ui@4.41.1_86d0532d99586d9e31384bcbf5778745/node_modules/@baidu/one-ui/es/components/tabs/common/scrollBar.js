...
import { IconPlusCircle, IconChevronRight, IconChevronLeft } from 'dls-icons-react';
...
var ScrollBar = /*#__PURE__*/function (_PureComponent) {
  ...
  function ScrollBar() {
    ...
    _this.renderPrevIcon = function () {
      ...
      var prevIconClassName = classnames(prefixCls + "-nav-prev", (_classnames = {}, _classnames[prefixCls + "-nav-prev-disabled"] = !canScrollForward, _classnames));
      var prevProps = {
        className: prevIconClassName,
        onClick: !canScrollForward ? null : _this.prev
      };
      return /*#__PURE__*/React.createElement("span", prevProps, /*#__PURE__*/React.createElement(IconChevronLeft, null));
    };
    ...
    _this.renderNextIcon = function () {
      ...
      var nextIconClassName = classnames(prefixCls + "-nav-next", (_classnames2 = {}, _classnames2[prefixCls + "-nav-next-disabled"] = !canScrollBackward, _classnames2));
      var nextProps = {
        className: nextIconClassName,
        onClick: !canScrollBackward ? null : _this.next
      };
      return /*#__PURE__*/React.createElement("span", nextProps, /*#__PURE__*/React.createElement(IconChevronRight, {
  ...
  _proto.componentDidMount = function componentDidMount() {
    ...
    this.debouncedResize = _debounce(function () {
  ...
  _proto.render = function render() {
    ...
    var addClassName = classnames(prefixCls + "-bar-add", prefixCls + "-bar-add-" + type);
    var scrollable = this.isScrollable();
    var containerClassName = classnames(prefixCls + "-bar", (_classnames3 = {}, _classnames3[prefixCls + "-bar-show-add"] = showAdd, _classnames3[prefixCls + "-bar-pagination-show"] = scrollable, _classnames3));
    ...
    }, scrollable ? this.renderPrevIcon() : null, scrollable ? this.renderNextIcon() : null, /*#__PURE__*/React.createElement("div", {
    ...
    }, sortable ? /*#__PURE__*/React.createElement(Sortable, {
      options: content,
      onChange: this.handleOnSort,
      renderOption: this.renderTab,
      onMove: this.handleMove
    }) : content.map(this.renderTab)))))), showAdd ? /*#__PURE__*/React.createElement(Button, {

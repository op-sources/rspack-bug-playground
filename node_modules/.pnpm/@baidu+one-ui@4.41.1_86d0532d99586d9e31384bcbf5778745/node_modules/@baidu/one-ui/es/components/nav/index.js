...
var Nav = (_dec = withConfigConsumer('nav'), _dec(_class = (_temp = _class2 = /*#__PURE__*/function (_PureComponent) {
  ...
  function Nav(props) {
    ...
    _this.setWidthWithResize = function () {
      ...
      var containerWidth = _this.navContainerRef.getBoundingClientRect().width;

      var indicatorWidth = lastOverflowedIndicatorPlaceholder.getBoundingClientRect().width;

      for (var i = 0; i < normalMenus.length; i++) {
        totalItemWidth += normalMenus[i].getBoundingClientRect().width;

        if (containerWidth >= totalItemWidth + indicatorWidth) {
          lastShowIndex = i;
        }
      }

      if (containerWidth < normalMenus[0].getBoundingClientRect().width + indicatorWidth) {
        lastShowIndex = -1;
      }
  ...
  _proto.render = function render() {
    ...
    var _this$props2 = this.props,
        ...
        restProps = _objectWithoutPropertiesLoose(_this$props2, ["className", "prefixCls", "lightPrefix"]);

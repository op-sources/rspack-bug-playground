...
var MonthPicker = (_dec = withConfigConsumer('date-picker'), _dec(_class = (_temp = _class2 = /*#__PURE__*/function (_PureComponent) {
  ...
  function MonthPicker(props) {
    ...
    _this.renderDatePickerBody = function () {
      ...
      var datePickerPanelClassName = classnames(prefixCls + "-panel", prefixCls + "-panel-month", hideInput && prefixCls + "-panel-hide-input", prefixCls + "-panel-" + size);
      return /*#__PURE__*/React.createElement(Provider, {
        ...
        isMonthRender: true
      })), /*#__PURE__*/React.createElement(MonthPanel, _extends({}, _this.props, {
        isMonthRender: true,
        onClickMonth: _this.onSelectMonth
      })), /*#__PURE__*/React.createElement(YearPanel, _extends({}, _this.props, {
        isMonthRender: true
      }))));
    };

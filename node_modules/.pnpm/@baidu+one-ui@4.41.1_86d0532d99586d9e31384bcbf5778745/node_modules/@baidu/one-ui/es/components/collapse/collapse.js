...
var Collapse = (_dec = withConfigConsumer('collapse'), _dec(_class = (_temp = _class2 = /*#__PURE__*/function (_PureComponent) {
  _inheritsLoose(Collapse, _PureComponent);
  ...
  function Collapse(_props) {
    ...
    _this.renderPanel = function () {
      ...
      var childList = /*#__PURE__*/React.isValidElement(children) && isFragment(children) ? children.props.children : children;
      ...
      if (isFragment(children)) {
        return /*#__PURE__*/React.createElement(React.Fragment, null, newChildren);
      }

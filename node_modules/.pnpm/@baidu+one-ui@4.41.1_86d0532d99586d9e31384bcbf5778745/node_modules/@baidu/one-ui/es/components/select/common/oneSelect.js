...
var OneSelect = /*#__PURE__*/function (_PureComponent) {
  ...
  function OneSelect(_props) {
    ...
    _this.componentDidUpdate = function (prevProps, prevState) {
      if (isMultipleOrTags(_this.props)) {
        ...
        if (_this.selectionRef && !_isEqual(_this.state.value, prevState.value)) {
    ...
    _this.onInputKeyDown = function (event) {
      ...
      if (_this.getRealOpenState(state)) {
        var _menu = _this.selectTriggerRef.getInnerManualRef();

        if (_menu && _menu.onKeyDown(event, _this.handleBackfill)) {
          event.preventDefault();
          event.stopPropagation();
        }
      }
    ...
    _this.onMenuSelect = function (_ref) {
      ...
      var exclusive = getPropValue(item, 'exclusive');
    ...
    _this.onMenuDeselect = function (_ref2) {
      ...
      if (domEvent.type === 'click' || domEvent.type === 'keydown') {
    ...
    _this.getOptionInfoBySingleValue = function (value, optionsInfo) {
      ...
      var defaultInfo = {
        option: /*#__PURE__*/React.createElement(SelectOption, {
          value: value,
          key: value
        }, value),
        value: value,
    ...
    _this.getPlaceholderElement = function () {
      ...
      if (isCombobox(_this.props) && value.length === 1 && !value[0]) {
        hidden = false;
      }
    ...
    _this.getInputElement = function () {
      ...
      var props = _this.props;
      var inputElement = props.getInputElement ? props.getInputElement() : /*#__PURE__*/React.createElement("input", {
        id: props.id,
        autoComplete: "off"
      });
      ...
      }, /*#__PURE__*/React.cloneElement(inputElement, {
    ...
    _this.getValueByInput = function (string) {
      ...
      splitBySeparators(string, tokenSeparators).forEach(function (label) {
        ...
        if (multiple) {
          var _value3 = _this.getValueByLabel(label);

          if (_value3 && findIndexInValueBySingleValue(nextValue, _value3) === -1) {
            nextValue = nextValue.concat(_value3);
            hasNewValue = true;

            _this.fireSelect(_value3);
          }
    ...
    _this.updateFocusClassName = function () {
      ...
      var lightPrefix = props.lightPrefix,
      ...
      if (_this._focused) {
        classes(rootRef).add(prefixCls + "-focus").add(COMPONENT_FOCUS(lightPrefix));
      } else {
        classes(rootRef).remove(prefixCls + "-focus").remove(COMPONENT_FOCUS(lightPrefix));
      }
    };
    ...
    _this.maybeFocus = function (open, needFocus) {
      if (needFocus || open) {
        ...
        } else if (_this.selectionRef && activeElement !== _this.selectionRef) {
          _this.selectionRef.focus();
    ...
    _this.renderFilterOptions = function () {
      ...
      var _this$props4 = _this.props,
          ...
          lightPrefix = _this$props4.lightPrefix,
          _this$props4$checkbox = _this$props4.checkboxPrefixCls,
          checkboxPrefixCls = _this$props4$checkbox === void 0 ? lightPrefix + "-checkbox" : _this$props4$checkbox,
      ...
      if (tags) {
        ...
        var _value4 = _this.state.value;
        _value4 = _value4.filter(function (singleValue) {
          return childrenKeys.indexOf(singleValue) === -1 && (!inputValue || String(singleValue).indexOf(String(inputValue)) > -1);
        });

        _value4.forEach(function (singleValue) {
          var key = singleValue;
          var children = /*#__PURE__*/React.createElement("span", null, /*#__PURE__*/React.createElement(Checkbox, {
            checked: true,
          ...
          var menuItem = /*#__PURE__*/React.createElement(MenuItem, {
        ...
        if (inputValue) {
          ...
          if (notFindInputItem) {
            options.unshift( /*#__PURE__*/React.createElement(MenuItem, {
              style: UNSELECTABLE_STYLE,
              role: "option",
              attribute: UNSELECTABLE_ATTRIBUTE,
              value: inputValue,
      ...
      if (!options.length && notFoundContent) {
        options = [/*#__PURE__*/React.createElement(MenuItem, {
          style: UNSELECTABLE_STYLE,
          attribute: UNSELECTABLE_ATTRIBUTE,
          disabled: true,
          role: "option",
      ...
      if (multiple && showCheckAll && Object.keys(optionsInfo).length > 0 && !inputValue && !loading) {
        options.unshift( /*#__PURE__*/React.createElement(MenuItem, {
          ...
          prefixCls: checkboxPrefixCls
        }, _this.getCheckAllState())), /*#__PURE__*/React.createElement("span", null, "\u5168\u9009")));
      }
    ...
    _this.renderFilterOptionsFromChildren = function (children, childrenKeys, menuItems) {
      ...
      React.Children.forEach(children, function (child) {
        ...
        warning(child.type && child.type.isSelectOption, 'the children of `Select` should be `Select.Option` or `Select.OptGroup`, ' + ("instead of `" + (child.type && child.type.name || child.type && child.type.displayName || child.type) + "`."));
        var childValue = getValuePropValue(child);
        ...
        if (_this.filterOption(inputValue, child)) {
          ...
          var childNode = typeof _children === 'string' ? /*#__PURE__*/React.createElement(SearchText, {
            showSearch: true,
            text: _children,
            searchValue: inputValue,
            prefixCls: prefixCls
          }) : /*#__PURE__*/React.createElement("span", null, _children);

          if ((tags || multiple // 兼容原Option包含 CheckboxText 逻辑（包含时，则原样输出）
          ) && !React.Children.toArray(_children).some(function (node) {
            return /*#__PURE__*/isValidElement(node) && node.type === CheckboxText;
          })) {
            var checked = false;
            ...
            childNode = /*#__PURE__*/React.createElement("span", {
              className: prefixCls + "-dropdown-menu-content"
            }, exclusive ? null : /*#__PURE__*/React.createElement(Checkbox, {
              checked: checked,
              prefixCls: checkboxPrefixCls,
              disabled: disabled
            }), childNode);
          ...
          var menuItem = /*#__PURE__*/React.createElement(MenuItem, _extends({
            style: UNSELECTABLE_STYLE,
            attribute: UNSELECTABLE_ATTRIBUTE,
            value: childValue,
            key: childValue,
    ...
    _this.renderTopControlNode = function () {
      ...
      if (isSingleMode(props)) {
        ...
        if (!showSearch) {
          ...
          innerNode = [selectedValue, /*#__PURE__*/React.createElement("div", {
      ...
      if (isMultipleOrTags(props)) {
        ...
        if (type === 'enum' || type === 'count' || type === 'custom') {
          // 枚举类型
          var firstLabel = limitedCountValue[0] != null ? getMultipleCheckboxLabel(_this.getOptionInfoBySingleValue(limitedCountValue[0]).label || '') : '';
          var secondLabel = limitedCountValue[1] != null ? getMultipleCheckboxLabel(_this.getOptionInfoBySingleValue(limitedCountValue[1]).label || '') : '';
          ...
          if (type === 'count') {
            ...
            if (typeof titleCallback.customRenderTarget === 'function') {
              text = titleCallback.customRenderTarget(value, value.map(function (v) {
                return _this.getOptionInfoBySingleValue(v);
              }));
            } else {
              text = _selectorName;
            }
          ...
          var _selectedValue = limitedCountValueLength ? /*#__PURE__*/React.createElement("div", {
            key: "value",
        ...
        selectedValueNodes = limitedCountValue.map(function (singleValue) {
          ...
          var infoLabel = /*#__PURE__*/React.isValidElement(info.label) && info.label.props.label || info.label;
        ...
        if (showSearch) {
          selectedValueNodes.push( /*#__PURE__*/React.createElement("li", {
            className: inputClasses,
            key: "input"
          }, _this.getInputElement()));
        }

        innerNode = selectedValueNodes.length ? /*#__PURE__*/React.createElement("ul", {
      ...
      innerNode = /*#__PURE__*/React.createElement("ul", null, selectedValueNodes);
      return /*#__PURE__*/React.createElement("div", {
        className: className,
        ref: _this.saveTopCtrlRef
      }, _this.getPlaceholderElement(), innerNode);
  ...
  OneSelect.getDerivedStateFromProps = function getDerivedStateFromProps(props, state) {
    ...
    if ('value' in props) {
      var _value5 = OneSelect.getValueFromProps(props);

      newState.value = _value5;
  ...
  _proto.getToggleAllValue = function getToggleAllValue() {
    ...
    if (value.length > 0 && !value.every(function (val) {
      return optionsInfo[getMapKey(val)].disabled;
    })) {
      // 取消全选
  ...
  _proto.renderClear = function renderClear() {
    ...
    var clear = /*#__PURE__*/React.createElement("span", _extends({
      key: "clear",
  ...
  _proto.render = function render() {
    ...
    if (suffixIcon) {
      if (typeof suffixIcon === 'string') {
        suffixIconRender = /*#__PURE__*/React.createElement(IconSvg, {
          type: suffixIcon
        });
      } else {
    ...
    var defaultTitleRender = /*#__PURE__*/React.createElement("div", _extends({
      ref: this.saveSelectionRef,
      key: "selection",
      className: sectionCls // @ts-ignore
      ,
      type: type
    }, extraSelectionProps), ctrlNode, this.renderClear(), suffixIconRender ? /*#__PURE__*/React.createElement("span", _extends({
      key: "custom-key",
      className: prefixCls + "-custom-key",
      style: UNSELECTABLE_STYLE
    }, UNSELECTABLE_ATTRIBUTE), suffixIconRender) : /*#__PURE__*/React.createElement("span", _extends({
      key: "arrow",
      className: prefixCls + "-arrow",
      style: UNSELECTABLE_STYLE
    }, UNSELECTABLE_ATTRIBUTE, {
      onClick: this.onArrowClick
    }), inputIcon || /*#__PURE__*/React.createElement(IconChevronDown, null)), multiple ? this.renderTotalDom() : null); // triggerTarget存在的时候dropdownIndependentWidth默认为false，否则为true

    var normalizedDropdownIndependentWidth = 'dropdownIndependentWidth' in props ? props.dropdownIndependentWidth : !!triggerTarget;
    return /*#__PURE__*/React.createElement(SelectTrigger, {
      onPopupFocus: this.onPopupFocus,
      onMouseEnter: this.onMouseEnter,
      onMouseLeave: this.onMouseLeave,
      dropdownAlign: props.dropdownAlign,
      dropdownClassName: props.dropdownClassName,
      dropdownIndependentWidth: normalizedDropdownIndependentWidth,
      ...
      action: action,
      footer: footer
    }, triggerTarget ? /*#__PURE__*/isValidElement(triggerTarget) ? triggerTarget : /*#__PURE__*/React.createElement("span", null, triggerTarget) : /*#__PURE__*/React.createElement("div", {
      id: props.id,
      style: props.style,
...
OneSelect.getInputValueForCombobox = function (props, optionsInfo, useDefaultValue) {
  ...
  if ('value' in props && !useDefaultValue) {
    values = toArray(props.value);
  }

  if ('defaultValue' in props && useDefaultValue) {
    values = toArray(props.defaultValue);
  }
...
OneSelect.getOptionsInfoFromProps = function (props, preState) {
  ...
  options.forEach(function (option) {
    ...
    var disabled = getPropValue(option, 'disabled');
    var exclusive = getPropValue(option, 'exclusive');
  ...
  if (preState) {
    ...
    var _value6 = preState.value;

    _value6.forEach(function (v) {
      var key = getMapKey(v);
...
OneSelect.getValueFromProps = function (props, useDefaultValue) {
  ...
  if ('defaultValue' in props && useDefaultValue) {
    value = toArray(multiple && props.defaultValue == null ? [] : props.defaultValue);
  } else if ('value' in props) {
    value = toArray(multiple && props.value == null ? [] : props.value);
  }

...
declare type TableColumnFilterItem = {
    /**
     * 标签
     */
    text: string;
...
export declare type TableColumnSortOrder = 'ascend' | 'descend' | boolean;
export interface TableColumnProps extends TableColumnFilterProps {
     ...
     * @param index 列索引
     */
    render?: (value: any, record: Record<string, any>, index: number) => (ReactNode | {
...
export interface TableProps extends BaseProps {
    ...
    */
    ...
    onSortClick?: (e: {
        ...
        sortColumn: null | TableColumnProps;
    }) => void;
    /**
     * 筛选改变时触发
     */

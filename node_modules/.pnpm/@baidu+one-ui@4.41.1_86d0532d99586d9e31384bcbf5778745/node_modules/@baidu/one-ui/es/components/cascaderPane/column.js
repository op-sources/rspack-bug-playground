...
var Column = /*#__PURE__*/function (_PureComponent) {
  ...
  _proto.render = function render() {
    ...
    var className = classnames((_classnames = {}, _classnames[this.prefix('menu')] = true, _classnames[this.prefix('menu-fixed-width')] = width, _classnames[this.prefix('menu-has-header')] = !!header, _classnames[this.prefix('menu-has-footer')] = !!footer, _classnames));
    ...
    return /*#__PURE__*/React.createElement("ul", {
      className: className,
      style: colStyle
    }, header, CustomItemRender && this.renderCustomItem(CustomItemRender), renderGroup ? this.renderGroupOptions(options) : this.renderOptions(options), footer);
  };
  ...
  _proto.renderGroupOptions = function renderGroupOptions(options) {
    ...
    return firstColumnGroup.map(function (group, index) {
      return /*#__PURE__*/React.createElement("ul", {

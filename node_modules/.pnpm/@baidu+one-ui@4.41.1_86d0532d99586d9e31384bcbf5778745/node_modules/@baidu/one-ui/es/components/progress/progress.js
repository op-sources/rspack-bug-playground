...
import { IconTimes, IconTimesCircle, IconCheck, IconCheckCircle } from 'dls-icons-react';
...
var ProgressStatuses = _values(PROGRESS_STATUS_MAP);
...
var Progress = (_dec = withConfigConsumer('progress'), _dec(_class = (_temp = _class2 = /*#__PURE__*/function (_PureComponent) {
  ...
  function Progress() {
    ...
    _this.renderProcessInfo = function (prefixCls, progressStatus) {
      ...
      if (format || progressStatus !== 'exception' && progressStatus !== 'success') {
        ...
        if (type === 'line') {
          text = /*#__PURE__*/React.createElement("span", null, /*#__PURE__*/React.createElement(IconTimesCircle, {
            className: prefixCls + "-close-circle-icon"
          }));
        } else {
          text = /*#__PURE__*/React.createElement("span", null, /*#__PURE__*/React.createElement(IconTimes, {
            className: prefixCls + "-close-icon"
          }));
        }
      } else if (progressStatus === 'success') {
        if (type === 'line') {
          text = /*#__PURE__*/React.createElement("span", null, /*#__PURE__*/React.createElement(IconCheckCircle, {
            className: prefixCls + "-check-circle-icon"
          }));
        } else {
          text = /*#__PURE__*/React.createElement("span", null, /*#__PURE__*/React.createElement(IconCheck, {
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      style: style
    }, type === 'line' ? /*#__PURE__*/React.createElement(Line, lineProps, progressInfo) : null, type === 'circle' ? /*#__PURE__*/React.createElement(Circle, circleProps, progressInfo) : null);
  };

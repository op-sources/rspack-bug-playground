...
import { IconSortAsc, IconSortDesc } from 'dls-icons-react';
import Loading from '../loading';
import TableComponent from './common/table';
import { stopPropagation, flatArray, treeMap, flatFilter, createStore, classnames } from '../../core/commonTools';
...
function getFilteredValueColumns(columns, useDefault) {
  ...
  var filteredValue = flatFilter(columns || [], function (column) {
...
var emptyObject = {};
;
var Table = (_dec = withConfigConsumer('table'), _dec(_class = (_temp = _class2 = /*#__PURE__*/function (_PureComponent) {
  ...
  function Table(_props) {
    ...
    _this.handleFilter = function (columnKey, nextFilters) {
      ...
      var filters = _extends({}, _this.state.filters, (_extends2 = {}, _extends2[columnKey] = nextFilters, _extends2)); // Remove filters not in current columns
    ...
    _this.renderColumnTitle = function (column) {
      ...
      if ((column.filters && column.filters.length > 0 || column.filterDropdown) && column.filterIconVisible !== false) {
        ...
        filterDropdown = /*#__PURE__*/React.createElement(FilterDropdown, _extends({
          ...
          columnKey: key
        }, _pick(column, ['filterMultiple', 'filterProps', 'filterDropdown', 'filters', 'filterDropdownVisible', 'onFilterDropdownVisibleChange', 'filterIcon', 'filterWithoutConfirm', 'filteredValue', 'defaultFilteredValue', 'onFilter', 'filterDropdownTitle', 'filterDropdownProps'])));
      }
      ...
      if (column.sorter || customSortNode) {
        ...
        sortButton = customSortNode || /*#__PURE__*/React.createElement(Button, {
          size: size,
          type: "text",
          onClick: clickSorter,
          className: prefixCls + "-sort-icon-set"
        }, /*#__PURE__*/React.createElement(IconSortAsc, {
          className: classnames(prefixCls + "-sorted-up-icon", (_classnames = {}, _classnames[prefixCls + "-sorted-up-icon-active"] = isAscend, _classnames))
        }), /*#__PURE__*/React.createElement(IconSortDesc, {
          className: classnames(prefixCls + "-sorted-down-icon", (_classnames2 = {}, _classnames2[prefixCls + "-sorted-up-icon-active"] = isDescend, _classnames2))
        }));
      }
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        title: title,
        desc: column.desc
      })), sortButton || filterDropdown || column.customOperate && column.customOperate.length ? /*#__PURE__*/React.createElement("div", {
        className: prefixCls + "-column-operate"
      }, sortButton ? /*#__PURE__*/React.createElement("span", {
        className: classnames(prefixCls + "-column-operate-item", prefixCls + "-column-operate-sort-item", (_classnames3 = {}, _classnames3[prefixCls + "-column-operate-item-autohide"] = autohideSort, _classnames3))
      }, sortButton) : null, filterDropdown ? /*#__PURE__*/React.createElement("span", {
        className: classnames(prefixCls + "-column-operate-item", prefixCls + "-column-operate-filter-item", (_classnames4 = {}, _classnames4[prefixCls + "-column-operate-item-autohide"] = autohideFilter, _classnames4))
      }, filterDropdown) : null, column.customOperate && column.customOperate.map(function (itemNode, key) {
        return itemNode ? /*#__PURE__*/React.createElement("span", {
    ...
    _this.renderSelectionBox = function (_, record, index) {
      ...
      var checkboxNode = /*#__PURE__*/React.createElement("span", {
  ...
  Table.getDerivedStateFromProps = function getDerivedStateFromProps(props, state) {
    ...
    if ('pagination' in props && pagination !== state.pagination) {
      if (pagination === false) {
        ...
        var newPagination = _extends({}, defaultPagination, state.pagination);
    ...
    if (filteredValueColumns.length > 0) {
      ...
      var newFilters = _extends({}, state.filters);
  ...
  _proto.getLocale = function getLocale() {
    return _extends({}, defaultLocale, this.props.locale);
  };
  ...
  _proto.recursiveSort = function recursiveSort(data, sorterFn) {
    ...
    return data.sort(sorterFn).map(function (item) {
      ...
      return item[childrenColumnName] ? _extends({}, item, (_extends3 = {}, _extends3[childrenColumnName] = _this6.recursiveSort(item[childrenColumnName], sorterFn), _extends3)) : item;
    });
  };
  ...
  _proto.renderPagination = function renderPagination() {
    ...
    return total > 0 ? /*#__PURE__*/React.createElement(Pagination, _extends({
      key: "pagination",
  ...
  _proto.normalizeColumns = function normalizeColumns(columns) {
    ...
    return treeMap(columns, function (originColumn, i, parent) {
      var column = _extends({}, originColumn, {
        renderTitle: _this7.renderColumnTitle
      });

      if (_isNumber(column.minWidth) && _isNumber(column.width) && column.minWidth > column.width) {
  ...
  _proto.renderRowSelection = function renderRowSelection() {
    ...
    if (rowSelection) {
      ...
      var selectionColumnClass = classnames(prefixCls + "-selection-column", (_classnames5 = {}, _classnames5[prefixCls + "-selection-column-custom"] = rowSelection.selections, _classnames5));
      var selectionColumn = {
      ...
      if (rowSelection.type !== 'radio') {
        ...
        selectionColumn.title = /*#__PURE__*/React.createElement(SelectionCheckboxAll, {
          store: this.store,
  ...
  _proto.render = function render() {
    ...
    var _this$props3 = this.props,
        ...
        restProps = _objectWithoutPropertiesLoose(_this$props3, ["style", "className", "prefixCls", "showHeader", "loading", "size", "type", "onDragStart", "onDraging", "onDragEnd", "useStickyFixTop", "pagination", "cellLines", "headCellLines", "loadingOption", "bordered", "headBordered", "variant", "lightPrefix"]);
    ...
    var table = /*#__PURE__*/React.createElement(TableComponent, _extends({
      ref: this.tableRef,
    ...
    return /*#__PURE__*/React.createElement("div", {
      className: classnames(prefixCls + "-wrapper", className, (_classnames7 = {}, _classnames7[prefixCls + "-wrapper-no-header"] = !showHeader, _classnames7[prefixCls + "-wrapper-no-columns"] = !hasColumns, _classnames7), prefixCls + "-wrapper-" + type),
      style: Object.keys(clamps).length ? _extends({}, clamps, style) : style,
      ref: this.root
    }, /*#__PURE__*/React.createElement("div", {
      className: paginationPatchClass
    }, hasColumns ? table : loading ? /*#__PURE__*/React.createElement(Loading, {

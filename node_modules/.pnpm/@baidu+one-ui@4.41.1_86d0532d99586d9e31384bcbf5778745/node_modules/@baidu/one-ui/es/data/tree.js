...
export function walk(items, _ref, context) {
...
export var ROOT_VALUE = '__ONE_TREE_ROOT_VALUE__';
export var Tree = /*#__PURE__*/function () {
  function Tree(items, checkedKeys, names, leaf) {
    ...
    var flatten = [];
    this.tree = walk([_extends({}, this.root, (_extends2 = {}, _extends2[childrenKey] = items, _extends2))], {
      deepKey: childrenKey,
  ...
  _proto.search = function search(query, config) {
    ...
    return this.flatten.filter(function (path) {
      ...
      if (_last(path).selectable === false) {
        return false;
      }

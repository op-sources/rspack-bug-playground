...
exports.getCheckedKeyIsDisabledByParentRelationMap = exports.getCheckedKeyIsDisabled = exports.formatSelectedList = exports.formatParentRelationMap = exports.getParentExpandedKeys = exports.getCandidateNumber = void 0;

var getCandidateNumber = function getCandidateNumber(allDataMap, candidateList) {
...
exports.getCandidateNumber = getCandidateNumber;

var getParentExpandedKeys = function getParentExpandedKeys(checkedKeys, entities) {
...
exports.getParentExpandedKeys = getParentExpandedKeys;

var formatParentRelationMap = function formatParentRelationMap(allDataMap) {
...
exports.formatParentRelationMap = formatParentRelationMap;

var formatSelectedList = function formatSelectedList(list, parentRelationMap, allDataMap) {
  var entities = {};
  var topLevel = [];
...
exports.formatSelectedList = formatSelectedList;

var getCheckedKeyIsDisabled = function getCheckedKeyIsDisabled(key, keyEntities, allDataMap) {
...
exports.getCheckedKeyIsDisabled = getCheckedKeyIsDisabled;

var getCheckedKeyIsDisabledByParentRelationMap = function getCheckedKeyIsDisabledByParentRelationMap(key, parentRelationMap, allDataMap) {
  if (allDataMap[key] && allDataMap[key].disabled) {
    return true;
  }
...
exports.getCheckedKeyIsDisabledByParentRelationMap = getCheckedKeyIsDisabledByParentRelationMap;
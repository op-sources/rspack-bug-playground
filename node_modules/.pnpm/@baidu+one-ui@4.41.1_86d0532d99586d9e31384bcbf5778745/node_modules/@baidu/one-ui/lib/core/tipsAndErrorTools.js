...
exports.tipsAndErrorRender = exports.getPopoverProps = exports.getTipClassName = void 0;
...
var getTipClassName = function getTipClassName(props, key, showErrorFlag) {
  ...
  return (0, _commonTools.classnames)(tipClass, tipClass + "-" + realLocation, tipClass + "-" + realLocation + "-" + size, (_classnames = {}, _classnames[tipClass + "-error"] = showErrorFlag && errorMessage, _classnames));
};
...
var tipsAndErrorRender = function tipsAndErrorRender(props) {
  ...
  if (isSameLocation) {
    return !isTipLayer && isSameLocation && renderDetail ? /*#__PURE__*/_react["default"].createElement("div", tipProps, renderDetail) : null;
  }

  var render = (_render = {}, _render[realTipLocation] = !isTipLayer && !isSameLocation && tipText ? /*#__PURE__*/_react["default"].createElement("div", {
    className: getTipClassName(props, 'tipLocation', false),
    key: "text-area-tips"
  }, tipText) : null, _render[realErrorLocation] = !isErrorLayer && !isSameLocation && errorMessage ? /*#__PURE__*/_react["default"].createElement("div", {

...
var _cascaderPane = _interopRequireDefault(require("../cascaderPane"));
...
;
var Cascader = (_dec = (0, _context.withConfigConsumer)('cascader'), _dec(_class = (_temp = _class2 = /*#__PURE__*/function (_PureComponent) {
  ...
  function Cascader(props) {
    ...
    _this.handleCheckboxChange = function (value) {
      ...
      if (!('value' in _this.props)) {
        ...
        tree = new _tree.Tree(options, value, fieldNames);
    ...
    _this.handleOnHover = function (option, columnIndex, value) {
      var tree = _this.state.tree;
      option = tree.getNormalizedOption((0, _last2["default"])(value), value);
    ...
    (0, _warning["default"])(!('width' in props), 'The `width` prop of `Cascader` is deprecated, use `className` or `style` instead');
    _this.state = {
  ...
  _proto.render = function render() {
    ...
    var _this$props3 = this.props,
        ...
        mergeChecked = _this$props3.mergeChecked,
        displayOptions = _this$props3.displayOptions;
    ...
    var rcTriggerProps = {
      ...
      popupClassName: (0, _commonTools.classnames)(prefixCls + "-menus-" + size, popupClassName),
      ...
      popup: /*#__PURE__*/_react["default"].createElement(_cascaderPane["default"], cascaderPaneProps),
      stretch: popupWidthStretch === 'min-width' ? 'minWidth' : popupWidthStretch
    };
    return /*#__PURE__*/_react["default"].createElement(_rcTrigger["default"], (0, _extends2["default"])({}, rcTriggerProps, {
      ref: function ref(_ref) {
        return _this2.rcTrigger = _ref;
      }
    }), /*#__PURE__*/_react["default"].createElement(_trigger["default"], triggerPorps));
  };
  ...
  showCheckAll: false,
  displayParent: true
}, _class2.ALL_VALUE = void 0, _class2.getDerivedStateFromProps = function (props, state) {
  var newState = {};
  var needBuildTree = false;
  var value = state.value;

  if ('value' in props && !(0, _shallowequal["default"])(props.value || [], state.value)) {
    value = props.value || [];
    newState.value = value;
    needBuildTree = true;
  }

  if (!(0, _isEqual2["default"])(props.options, state.optionsClone)) {
    newState.optionsClone = (0, _cloneDeepWith2["default"])(props.options, function (value) {
  ...
  if (needBuildTree) {
    ...
    var tree = new _tree.Tree(newState.options || state.options, checkedKeys, props.fieldNames);

    if (props.multiple) {
      var keys = tree.getCheckedKeys();
      newState.resultOptions = tree.getNormalizedOptions(keys);
      newState.value = keys;
    } else {
...
Cascader.ALL_VALUE = _tree.ROOT_VALUE;

...
var OneSelect = /*#__PURE__*/function (_PureComponent) {
  ...
  function OneSelect(_props) {
    ...
    _this.componentDidUpdate = function (prevProps, prevState) {
      if ((0, _selectTools.isMultipleOrTags)(_this.props)) {
        ...
        if (_this.selectionRef && !(0, _isEqual2["default"])(_this.state.value, prevState.value)) {
    ...
    _this.getValueByInput = function (string) {
      ...
      (0, _selectTools.splitBySeparators)(string, tokenSeparators).forEach(function (label) {
        ...
        if (multiple) {
          ...
          if (_value3 && (0, _selectTools.findIndexInValueBySingleValue)(nextValue, _value3) === -1) {
    ...
    _this.updateFocusClassName = function () {
      ...
      if (_this._focused) {
        (0, _componentClasses["default"])(rootRef).add(prefixCls + "-focus").add((0, _config.COMPONENT_FOCUS)(lightPrefix));
      } else {
        (0, _componentClasses["default"])(rootRef).remove(prefixCls + "-focus").remove((0, _config.COMPONENT_FOCUS)(lightPrefix));
      }
    };
      ...
      _react["default"].Children.forEach(children, function (child) {
        ...
        if (_this.filterOption(inputValue, child)) {
          ...
          if ((tags || multiple // 兼容原Option包含 CheckboxText 逻辑（包含时，则原样输出）
            ...
            childNode = /*#__PURE__*/_react["default"].createElement("span", {
              className: prefixCls + "-dropdown-menu-content"
            }, exclusive ? null : /*#__PURE__*/_react["default"].createElement(_checkbox["default"], {
              checked: checked,
              prefixCls: checkboxPrefixCls,
              disabled: disabled
            }), childNode);
  ...
  _proto.render = function render() {
    ...
    }), inputIcon || /*#__PURE__*/_react["default"].createElement(_dlsIconsReact.IconChevronDown, null)), multiple ? this.renderTotalDom() : null); // triggerTarget存在的时候dropdownIndependentWidth默认为false，否则为true
    ...
    return /*#__PURE__*/_react["default"].createElement(_selectTrigger["default"], {
      ...
      action: action,
      footer: footer
    }, triggerTarget ? /*#__PURE__*/(0, _react.isValidElement)(triggerTarget) ? triggerTarget : /*#__PURE__*/_react["default"].createElement("span", null, triggerTarget) : /*#__PURE__*/_react["default"].createElement("div", {
      id: props.id,
      style: props.style,

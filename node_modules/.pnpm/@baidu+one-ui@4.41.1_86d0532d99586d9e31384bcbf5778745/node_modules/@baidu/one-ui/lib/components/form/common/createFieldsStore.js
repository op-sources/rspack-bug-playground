...
var FieldsStore = /*#__PURE__*/function () {
  function FieldsStore(_fields) {
    ...
    this.setFieldsInitialValue = function (initialValues) {
      ...
      Object.keys(flattenedInitialValues).forEach(function (name) {
        if (fieldsMeta[name]) {
          _this.setFieldMeta(name, (0, _extends2["default"])({}, _this.getFieldMeta(name), {
    ...
    this.getAllValues = function () {
      ...
      return Object.keys(fieldsMeta).reduce(function (acc, name) {
        return (0, _set2["default"])(acc, name, _this.getValueFromFields(name, fields));
      }, {});
    };
    ...
    this.getFieldMessage = function (name, type) {
      var messages = _this.getNestedField(name, function (fullName) {
        return (0, _formTools.getMessageStrs)(_this.getFieldMember(fullName, type));
      });
  ...
  _proto.setFields = function setFields(fields) {
    ...
    var nowFields = (0, _extends2["default"])({}, this.fields, fields);
    var nowValues = {};
    ...
    Object.keys(nowValues).forEach(function (f) {
      ...
      if (fieldMeta && fieldMeta.normalize) {
        ...
        if (nowValue !== value) {
          nowFields[f] = (0, _extends2["default"])({}, nowFields[f], {
            value: nowValue
          });
        }
      }
  ...
  _proto.setFieldsAsDirty = function setFieldsAsDirty() {
    ...
    Object.keys(this.fields).forEach(function (name) {
      ...
      if (field && fieldMeta && (0, _formTools.hasRules)(fieldMeta.validate)) {
        _this3.fields[name] = (0, _extends2["default"])({}, field, {
          dirty: true
        });
      }
    });
  ...
  _proto.getField = function getField(name) {
    return (0, _extends2["default"])({}, this.fields[name], {
      name: name
    });
  };
  ...
  _proto.getNotCollectedFields = function getNotCollectedFields() {
    ...
    return fieldsName.filter(function (name) {
      ...
      return (0, _set2["default"])(acc, field.name, (0, _createFormField["default"])(field));
    }, {});
  };
  ...
  _proto.getNestedAllFields = function getNestedAllFields() {
    ...
    return Object.keys(this.fields).reduce(function (acc, name) {
      return (0, _set2["default"])(acc, name, (0, _createFormField["default"])(_this6.fields[name]));

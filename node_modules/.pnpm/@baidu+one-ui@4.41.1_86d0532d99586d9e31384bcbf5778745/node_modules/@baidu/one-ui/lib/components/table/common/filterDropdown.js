...
var FilterMenu = /*#__PURE__*/function (_Component) {
  (0, _inheritsLoose2["default"])(FilterMenu, _Component);
  ...
  function FilterMenu(props) {
    ...
    _this.handleMenuItemClick = function (info) {
      ...
      var updater = function updater(state) {
        var keyPathOfSelectedItem = (0, _extends2["default"])({}, state.keyPathOfSelectedItem);
    ...
    _this.renderFilterIcon = function () {
      ...
      return filterIcon ? /*#__PURE__*/_react["default"].cloneElement(filterIcon, {
        ...
        className: (0, _commonTools.classnames)(filterIcon.props.className, (_classnames = {}, _classnames[prefixCls + "-icon"] = true, _classnames[prefixCls + "-filter-icon-normal"] = true, _classnames[prefixCls + "-filter-icon-selected"] = isSelected(_this.state.selectedKeys), _classnames))
      }) : /*#__PURE__*/_react["default"].createElement(_button["default"], {
        type: "text",
        size: size,
        className: (0, _commonTools.classnames)((_classnames2 = {}, _classnames2[prefixCls + "-icon"] = true, _classnames2[prefixCls + "-icon-visible"] = _this.state.visible, _classnames2))
      }, /*#__PURE__*/_react["default"].createElement(_dlsIconsReact.IconFilterSolid, {
        title: filterTitleText,
  ...
  _proto.shouldComponentUpdate = function shouldComponentUpdate(nextProps, nextState) {
    return !(0, _shallowequal["default"])(this.props, nextProps, function (a, b, key) {
    ...
    }) || !(0, _shallowequal["default"])(this.state, nextState, function (a, b, key) {
      if (key === 'selectedKeys') {
        return (0, _shallowequal["default"])(a, b);
      }
    });
  ...
  _proto.render = function render() {
    ...
    var multiple = filterMultiple;
    var dropdownMenuClass = (0, _commonTools.classnames)((_classnames3 = {}, _classnames3[dropdownPrefixCls + "-menu-without-submenu"] = !this.hasSubMenu(), _classnames3));

    var menus = /*#__PURE__*/_react["default"].createElement(FilterDropdownMenuWrapper, {
      className: (0, _commonTools.classnames)((_classnames4 = {}, _classnames4[prefixCls + "-dropdown-with-confirm"] = !filterWithoutConfirm, _classnames4[prefixCls + "-dropdown-with-title"] = !!filterDropdownTitle, _classnames4))
    }, !!filterDropdownTitle && /*#__PURE__*/_react["default"].createElement("div", {
      className: prefixCls + "-dropdown-title"
    }, filterDropdownTitle), filterDropdown ? filterDropdown : /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, /*#__PURE__*/_react["default"].createElement(_menu["default"], {
      multiple: multiple,
    ...
    }, this.renderMenus(filters)), !filterWithoutConfirm ? /*#__PURE__*/_react["default"].createElement("div", {
      ...
      type: "text-strong"
    }, filterConfirmText), /*#__PURE__*/_react["default"].createElement(_button["default"], {
      size: size,
  ...
  _proto.componentDidUpdate = function componentDidUpdate() {
    ...
    var node = (0, _reactDom.findDOMNode)(this); // TODO: FIXME，当前结构，暂时这样实现
...
FilterMenu.getDerivedStateFromProps = function (nextProps, prevState) {
  ...
  if ('selectedKeys' in nextProps && !(0, _shallowequal["default"])(prevState.selectedKeysProp, nextProps.selectedKeys)) {

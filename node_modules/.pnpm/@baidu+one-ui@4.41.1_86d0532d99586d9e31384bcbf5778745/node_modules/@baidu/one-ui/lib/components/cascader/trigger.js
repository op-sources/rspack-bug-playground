...
var Trigger = (_dec = (0, _context.withConfigConsumer)('cascader'), _dec(_class = (_temp = /*#__PURE__*/function (_PureComponent) {
  (0, _inheritsLoose2["default"])(Trigger, _PureComponent);
  ...
  function Trigger() {
    ...
    _this.handleInputKeyDown = function (e) {
      ...
      if (multiple && !e.target.value && e.keyCode === _KeyCode["default"].BACKSPACE && opts.length) {
  ...
  _proto.render = function render() {
    ...
    var _this$props3 = this.props,
        ...
        restProps = (0, _objectWithoutPropertiesLoose2["default"])(_this$props3, ["className", "style", "width", "disabled", "size", "options", "multiple", "expanded", "children", "allowClear", "showSearch", "prefixCls", "placeholder", "onInputChange", "inputPrefixCls", "displayRender", "displayParent", "onRemove", "onRemoveAll", "onSearch", "query", "before", "lightPrefix"]);
    var rawInputValue = this.state.rawInputValue;
    var arrowCls = (0, _commonTools.classnames)((_classnames = {}, _classnames[this.prefix('picker-arrow')] = true, _classnames[this.prefix('picker-arrow-expand')] = expanded, _classnames));
    var pickerCls = (0, _commonTools.classnames)(className, (0, _config.COMPONENT_MAIN)(lightPrefix), (_classnames2 = {}, _classnames2[this.prefix('picker')] = true, _classnames2[this.prefix('picker-disabled')] = disabled, _classnames2[this.prefix('picker-show-search')] = !!showSearch, _classnames2[this.prefix('picker-multiple')] = multiple, _classnames2[this.prefix('picker-expanded')] = expanded, _classnames2[this.prefix('picker-focus')] = expanded && !!showSearch, _classnames2[(0, _config.COMPONENT_FOCUS)(lightPrefix)] = expanded && !!showSearch, _classnames2[this.prefix(size)] = size, _classnames2));
    ...
    return children || /*#__PURE__*/_react["default"].createElement("div", (0, _extends2["default"])({
      style: (0, _extends2["default"])({
        width: width
      }, style),
      className: pickerCls
    }, restProps), before ? /*#__PURE__*/_react["default"].createElement("div", {
      className: this.prefix('picker-before')
    }, before) : null, /*#__PURE__*/_react["default"].createElement("div", {
      className: this.prefix('picker-main')
    }, result, (showPlaceholder || hasResult && showResult && !result && !hasQuery) && this.renderPlaceholder(), showQueryInput && this.renderQueryInput()), /*#__PURE__*/_react["default"].createElement("span", {
      className: this.prefix('picker-icon')
    }, clearable && /*#__PURE__*/_react["default"].createElement(_dlsIconsReact.IconTimesCircle, {
      className: this.prefix('picker-clear'),
      onClick: this.handleRemoveAll
    }), /*#__PURE__*/_react["default"].createElement(_dlsIconsReact.IconChevronDown, {
      type: "angle-down",
      className: arrowCls
    })));
  };
  ...
  _proto.renderQueryInput = function renderQueryInput() {
    ...
    return /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, /*#__PURE__*/_react["default"].createElement(_input["default"], {
      autoFocus: true,
      inputRef: this.saveInputRef // prefixCls={inputPrefixCls}
      ,
      className: (0, _commonTools.classnames)(this.prefix('input'), this.prefix('input-autosize')),
      value: query,
      autoComplete: "off",
  ...
  _proto.renderResult = function renderResult(options) {
    var _this$props5 = this.props,
        displayRender = _this$props5.displayRender,
  ...
  _proto.defaultRender = function defaultRender(options) {
    ...
    return /*#__PURE__*/_react["default"].createElement("span", {
      ...
      return /*#__PURE__*/_react["default"].createElement("span", {
        key: index
      }, o.label, !last && /*#__PURE__*/_react["default"].createElement(_dlsIconsReact.IconChevronRight, {
  ...
  _proto.renderResults = function renderResults() {
    ...
    var _this$props6 = this.props,
        ...
        mergeChecked = _this$props6.mergeChecked,
        displayOptions = _this$props6.displayOptions;

    if (!multiple || displayRender) {
      return this.renderResult(options);
    }

    var normalizedOptions = displayOptions ? displayOptions(options.map(function (option) {
      return option.item;
    })) : options.filter(function (option) {
      if (mergeChecked === 'keep-all') {
        return true;
      }

      if (mergeChecked === 'upwards') {
        var _option$parent;

        return !((_option$parent = option.parent) != null && _option$parent.checked);
      }
    ...
    return normalizedOptions.map(function (option) {
      ...
      var key = option.key,
          ...
          value = _option$value === void 0 ? key : _option$value,
          title = option.title,
          label = option.label,
          optionDisabled = option.disabled,
          deletable = option.deletable;
      return /*#__PURE__*/_react["default"].createElement("span", {
        className: (0, _commonTools.classnames)(_this3.prefix('picker-result'), (_classnames3 = {}, _classnames3[_this3.prefix('picker-result-disabled')] = disabled || optionDisabled, _classnames3)),
        key: value,
        title: title
      }, /*#__PURE__*/_react["default"].createElement("span", {
        className: _this3.prefix('picker-result-label')
      }, label), deletable !== false && /*#__PURE__*/_react["default"].createElement(_button["default"], {
        type: "text-aux",

...
var MenuItem = /*#__PURE__*/function (_PureComponent) {
  ...
  _proto.componentDidUpdate = function componentDidUpdate(prevProps) {
    ...
    if (!prevProps.active && active && (!parentMenu || !parentMenu["scrolled-" + eventKey])) {
      if (this.node) {
        (0, _domScrollIntoView["default"])(this.node, _reactDom["default"].findDOMNode(parentMenu), {
  ...
  _proto.render = function render() {
    ...
    var itemStyle = (0, _extends2["default"])({}, style);
    ...
    if (typeof itemIcon === 'function') {
      ...
      afterIcon = /*#__PURE__*/_react["default"].createElement(itemIcon, this.props);
    }

    return /*#__PURE__*/_react["default"].createElement("li", (0, _extends2["default"])({}, restProps, attrs, mouseEvent, {
      style: itemStyle,
      className: (0, _commonTools.classnames)(prefixCls + "-item", className, (_classnames = {}, _classnames[prefixCls + "-item-active"] = !disabled && active, _classnames[prefixCls + "-item-selected"] = selected, _classnames[prefixCls + "-item-disabled"] = disabled, _classnames)),
      ref: this.saveNode

...
var NumberInput = (_dec = (0, _context.withConfigConsumer)('number-input'), _dec(_class = (_temp = _class2 = /*#__PURE__*/function (_PureComponent) {
  ...
  _proto.render = function render() {
    ...
    var mainProps = {
      className: (0, _commonTools.classnames)(mainClass, (_classnames = {}, _classnames[(0, _config.COMPONENT_MAIN)(lightPrefix)] = true, _classnames[(0, _config.COMPONENT_FOCUS)(lightPrefix)] = hasFocus, _classnames[mainClass + "-focus"] = hasFocus, _classnames[mainClass + "-disabled"] = disabled, _classnames[mainClass + "-readonly"] = readOnly, _classnames)),
      style: {
        width: width
      }
    };
    ...
    var containerProps = {
      className: (0, _commonTools.classnames)(prefixCls, (_classnames2 = {}, _classnames2[prefixCls + "-with-spin"] = showSpinButtons, _classnames2))
    };
    var wrapperClass = prefixCls + "-wrapper";
    var wrapperProps = (0, _extends2["default"])({
      className: (0, _commonTools.classnames)(className, wrapperClass, prefixCls + "-" + size, prefixCls + "-" + mode, (_classnames3 = {}, _classnames3[prefixCls + "-error"] = errorMessage || showErrorWithoutErrorMessage, _classnames3[wrapperClass + "-" + mode] = mode, _classnames3[(0, _config.COMPONENT_INVALID)(lightPrefix)] = errorMessage || showErrorWithoutErrorMessage, _classnames3))
    }, restProps);
    var btnContainer = {

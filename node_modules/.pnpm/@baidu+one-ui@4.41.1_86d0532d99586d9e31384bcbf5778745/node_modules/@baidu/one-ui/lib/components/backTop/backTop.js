...
var BackTop = (_dec = (0, _context.withConfigConsumer)('back-top'), _dec(_class = (_temp = _class2 = /*#__PURE__*/function (_PureComponent) {
  (0, _inheritsLoose2["default"])(BackTop, _PureComponent);
  ...
  _proto.render = function render() {
    ...
    var classes = (0, _commonTools.classnames)(prefixCls, className, (_classnames = {}, _classnames[prefixCls + "-default"] = !target, _classnames));
    return this.state.visible ? /*#__PURE__*/_react["default"].createElement(_button["default"], {
      className: classes,
      style: style,
      onClick: this.scrollToTop,
      type: "translucent",
      size: "xsmall"
    }, /*#__PURE__*/_react["default"].createElement(_dlsIconsReact.IconArrowToTop, {

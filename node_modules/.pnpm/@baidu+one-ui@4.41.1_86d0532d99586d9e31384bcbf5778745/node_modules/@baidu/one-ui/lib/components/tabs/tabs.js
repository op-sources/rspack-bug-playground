...
var _tabNode = _interopRequireDefault(require("./common/tabNode"));
...
;
var Tabs = (_dec = (0, _context2.withConfigConsumer)('tabs'), _dec(_class = (_temp = _class2 = /*#__PURE__*/function (_PureComponent) {
  ...
  function Tabs(_props) {
    ...
    _this.onBeforeDelete = /*#__PURE__*/function () {
      var _ref = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(key, props) {
        var onBeforeDelete;
    ...
    _this.renderChildren = function () {
      ...
      _react["default"].Children.forEach(children, function (child) {
        ...
        var _child$props = child.props,
            ...
            key = child.key;
        var nodeProps = (0, _extends2["default"])({}, props, {
          key: key,
          currentKey: key,
          activeKey: activeKey,
          prefixCls: prefixCls,
          size: size,
          onClick: (0, _partial2["default"])(_this.onClick, key, props),
          onDelete: (0, _partial2["default"])(_this.onDelete, key, props),
          onBeforeDelete: (0, _partial2["default"])(_this.onBeforeDelete, key, props)
        });
        titles.push(nodeProps);
        var paneClassName = (0, _commonTools.classnames)(prefixCls + "-tab-pane", (_classnames = {}, _classnames[prefixCls + "-tab-pane-is-active"] = activeKey === key, _classnames[prefixCls + "-tab-pane-is-inactive"] = activeKey !== key, _classnames));
        newPaneChildren.push( /*#__PURE__*/_react["default"].createElement("div", {
          key: key,
          className: paneClassName
        }, child));
      });

      var activeIndex = (0, _findIndex2["default"])(titles, function (item) {
        return activeKey === item.key;
      });
      var total = titles.length;
      return {
        newTitleChildren: titles.map(function (props, index) {
          return /*#__PURE__*/_react["default"].createElement(_tabNode["default"], (0, _extends2["default"])({}, props, {
            index: index,
            total: total,
  ...
  _proto.render = function render() {
    ...
    var tabsClassNames = (0, _commonTools.classnames)(prefixCls, prefixCls + "-" + size, prefixCls + "-" + type, (_classnames2 = {}, _classnames2[prefixCls + "-hide-space"] = hideSpace, _classnames2[prefixCls + "-border-less"] = !bordered, _classnames2), className);

...
var FormItem = (_dec = (0, _context2.withConfigConsumer)('form'), _dec(_class = (_temp = _class2 = /*#__PURE__*/function (_PureComponent) {
  (0, _inheritsLoose2["default"])(FormItem, _PureComponent);
  ...
  function FormItem() {
        ...
        if (errors) {
          return (0, _commonTools.intersperseSpace)(errors.map(function (e, index) {
            ...
            if ( /*#__PURE__*/(0, _react.isValidElement)(e)) {
              node = e;
            } else if ( /*#__PURE__*/(0, _react.isValidElement)(e.message)) {
              node = e.message;
            }

            return node ? /*#__PURE__*/(0, _react.cloneElement)(node, {
              key: index
            }) : e.message;
          }));
        }
    ...
    _this.getControls = function (children, recursively) {
      ...
      for (var i = 0; i < childrenArray.length; i++) {
        ...
        if (! /*#__PURE__*/(0, _react.isValidElement)(child) || /*#__PURE__*/(0, _react.isValidElement)(child) && child.type === FormItem) {
          continue;
        }
  ...
  _proto.renderControl = function renderControl() {
    ...
    var className = (0, _commonTools.classnames)(prefixCls + "-item-control-wrapper", mergedWrapperCol.className);
    var onlyControl = this.getOnlyControl;
    ...
    }, /*#__PURE__*/_react["default"].createElement(Col, (0, _extends2["default"])({}, mergedWrapperCol, {
      className: className
  ...
  _proto.renderLabel = function renderLabel() {
    ...
    var labelColClassName = (0, _commonTools.classnames)(labelClsBasic, mergedLabelAlign === 'left' && labelClsBasic + "-left", mergedLabelCol.className);
    ...
    var labelClassName = (0, _commonTools.classnames)((_classnames2 = {}, _classnames2[prefixCls + "-item-required"] = required, _classnames2[prefixCls + "-item-no-colon"] = !computedColon, _classnames2));
    return /*#__PURE__*/_react["default"].createElement(Col, (0, _extends2["default"])({}, mergedLabelCol, {
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/_react["default"].createElement(Row, {
      className: (0, _commonTools.classnames)((_classnames3 = {}, _classnames3[prefixCls + "-item"] = true, _classnames3[prefixCls + "-item-with-help"] = this.helpShow, _classnames3["" + className] = !!className, _classnames3)),
      style: style
...
}, _class2.contextType = _context.FormContext, _temp)) || _class);

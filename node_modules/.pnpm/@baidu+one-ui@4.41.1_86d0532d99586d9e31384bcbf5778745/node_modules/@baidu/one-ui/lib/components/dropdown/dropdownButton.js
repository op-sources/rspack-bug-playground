...
var DropdownButton = (_dec = (0, _context.withConfigConsumer)('dropdown'), _dec(_class = (_temp = _class2 = /*#__PURE__*/function (_PureComponent) {
  (0, _inheritsLoose2["default"])(DropdownButton, _PureComponent);
  ...
  function DropdownButton(props) {
    ...
    _this.getSubMenuItem = function (option, optionLength, index) {
      ...
      if (option.children && option.children.length) {
        ...
        var subMenu = option.children.map(function (item, index) {
          ...
          if (showSearch && isStringLabel) {
            return /*#__PURE__*/_react["default"].createElement(MenuItem, menuItemProps, /*#__PURE__*/_react["default"].createElement("span", {
              onClick: onClick
          ...
          return /*#__PURE__*/_react["default"].createElement(MenuItem, (0, _extends2["default"])({}, menuItemProps, {
            key: key
        ...
        if (showSearch) {
          return /*#__PURE__*/_react["default"].createElement(SubMenu, subMenuProps, subMenu);
        }
      ...
      if (showSearch && isStringLabel) {
        ...
        }, menuItemProps), /*#__PURE__*/_react["default"].createElement("span", {
          onClick: onClick
        }, /*#__PURE__*/_react["default"].createElement(_searchText["default"], {
          text: option.label,
          showSearch: true,
    ...
    _this.getDropdownOverlay = function () {
      ...
      var empty = options.length === 0 || loading ? /*#__PURE__*/_react["default"].createElement(MenuItem, {
        disabled: true,
      ...
      var bottomCustomPanel = typeof BottomCustomPanel === 'function' ? /*#__PURE__*/_react["default"].createElement(BottomCustomPanel, _this.props) : BottomCustomPanel;
      ...
      }, showSearch ? /*#__PURE__*/_react["default"].createElement(MenuItem, (0, _extends2["default"])({}, searchMenuProps, {
        className: prefixCls + "-search-item"
      }), /*#__PURE__*/_react["default"].createElement(_searchBox["default"], searchProps)) : null, empty || options.map(function (option, index) {
  ...
  _proto.render = function render() {
    ...
    var normalizedTypeOverlayStyle = (0, _extends2["default"])({}, overlayStyle);
    var dropdownProps = {
      overlay: overlay,
    ...
    var dropdownButtonClassName = (0, _commonTools.classnames)(prefixCls, prefixCls + "-" + size, prefixCls + "-" + normalizedType, (_classnames = {}, _classnames[prefixCls + "-split"] = normalizedSplit, _classnames[prefixCls + "-open"] = visibleControlled ? visible : isExpand, _classnames));
    var buttonStyle = (0, _extends2["default"])({}, style);

    if (width) {
      buttonStyle.width = width;
    }

    var dropdownButtonContainerClassName = (0, _commonTools.classnames)(prefixCls + "-containers", className);
    return /*#__PURE__*/_react["default"].createElement("span", {
      className: dropdownButtonContainerClassName,
      ref: this.getDropdownContainer
    }, !normalizedSplit ? /*#__PURE__*/_react["default"].createElement(_dropdown["default"], dropdownProps, /*#__PURE__*/_react["default"].createElement("span", {
      ...
      type: normalizedType,
      icon: icon
    }, buttonProps), title, showArrow ? /*#__PURE__*/_react["default"].createElement(_dlsIconsReact.IconChevronDown, {
      ...
      size: size,
      icon: icon
    }, title), /*#__PURE__*/_react["default"].createElement(_dropdown["default"], (0, _extends2["default"])({
      placement: "bottomRight"
    }, dropdownProps), /*#__PURE__*/_react["default"].createElement("span", {
      ...
      disabled: disabled,
      type: normalizedType,
      icon: /*#__PURE__*/_react["default"].createElement(_dlsIconsReact.IconChevronDown, {
        className: prefixCls + "-arrow-down-icon"
      })
    }, buttonProps))))));
  };

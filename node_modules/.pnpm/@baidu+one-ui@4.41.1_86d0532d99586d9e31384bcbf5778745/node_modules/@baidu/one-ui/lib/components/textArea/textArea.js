...
var TextArea = (_dec = (0, _context.withConfigConsumer)('textarea'), _dec(_class = (_temp = _class2 = /*#__PURE__*/function (_PureComponent) {
  ...
  _proto.render = function render() {
    ...
    var otherProps = (0, _omit["default"])(props, ['prefixCls', 'maxRows', 'minRows', 'filterArray', 'defaultValue', 'showErrorWithoutErrorMessage', 'showErrorMessage', 'originTextAreaProps', 'containerRef', 'width', 'lightPrefix'].concat(_inputTools.commonRemoveProps, _commonTools.locationRemoveProps));
    ...
    var defaultProps = (0, _extends2["default"])({
      ...
      className: (0, _commonTools.classnames)(prefixCls, className, (0, _config.COMPONENT_MAIN)(lightPrefix), (_classnames = {}, _classnames[prefixCls + "-disabled"] = disabled, _classnames[prefixCls + "-readOnly"] = readOnly, _classnames[(0, _config.COMPONENT_INVALID)(lightPrefix)] = error, _classnames)),
    ...
    var containerProps = {
      className: (0, _commonTools.classnames)(prefixCls + "-container", (_classnames2 = {}, _classnames2[prefixCls + "-error"] = error, _classnames2))
    };

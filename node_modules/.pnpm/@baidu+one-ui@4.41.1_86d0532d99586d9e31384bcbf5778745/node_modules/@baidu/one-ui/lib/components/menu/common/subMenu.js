...
var updateDefaultActiveFirst = function updateDefaultActiveFirst(store, eventKey, defaultActiveFirst) {
  ...
  store.setState({
    defaultActiveFirst: (0, _extends3["default"])({}, state.defaultActiveFirst, (_extends2 = {}, _extends2[menuId] = defaultActiveFirst, _extends2))
  });
};

var SubMenu = /*#__PURE__*/function (_React$Component) {
  (0, _inheritsLoose2["default"])(SubMenu, _React$Component);
  ...
  _proto.renderChildren = function renderChildren(children) {
    ...
    var baseProps = {
      ...
      defaultActiveFirst: store.getState().defaultActiveFirst[(0, _util.getMenuIdFromSubMenuEventKey)(eventKey)],
      multiple: multiple,
      prefixCls: prefixCls,
    ...
    var mergedMotion = (0, _extends3["default"])({}, motion, {
      leavedClassName: prefixCls + "-hidden",
      removeOnLeave: false,
      motionAppear: haveRendered || !baseProps.visible || baseProps.mode !== 'inline'
    });
    return /*#__PURE__*/_react["default"].createElement(_CSSMotion["default"], (0, _extends3["default"])({
      visible: baseProps.visible
    }, mergedMotion), function (_ref) {
      var className = _ref.className,
          style = _ref.style;
      var mergedClassName = (0, _commonTools.classnames)(baseProps.prefixCls + "-sub", className);
      return /*#__PURE__*/_react["default"].createElement(_subPopupMenu["default"], (0, _extends3["default"])({}, baseProps, {
  ...
  _proto.render = function render() {
    ...
    var _this$props10 = this.props,
        ...
        restProps = (0, _objectWithoutPropertiesLoose2["default"])(_this$props10, ["isOpen", "className", "active", "disabled", "mode", "eventKey", "level", "title", "parentMenu", "children", "popupOffset", "popupClassName", "triggerSubMenuAction", "subMenuOpenDelay", "forceSubMenuRender", "subMenuCloseDelay", "builtinPlacements", "onClick", "lightPrefix"]);
    ...
    if (mode !== 'horizontal') {
      icon = mode !== 'vertical' ? /*#__PURE__*/_react["default"].createElement(_dlsIconsReact.IconChevronDown, {
    ...
    var titleNode = /*#__PURE__*/_react["default"].createElement("div", (0, _extends3["default"])({
      ref: this.saveSubMenuTitle,
      style: style,
      className: (0, _commonTools.classnames)(prefixCls + "-title", (_classnames = {}, _classnames[prefixCls + "-title-disabled"] = disabled, _classnames))
    }, titleMouseEvents, titleClickEvents, {
      "aria-expanded": isOpen
    }, ariaOwns, {
      "aria-haspopup": "true",
      title: typeof title === 'string' ? title : undefined
    }), title, icon || /*#__PURE__*/_react["default"].createElement("i", {
    ...
    var cls = (0, _commonTools.classnames)(prefixCls, className, prefixCls + "-" + mode, (_classnames2 = {}, _classnames2[this.getOpenClassName()] = isOpen, _classnames2[this.getActiveClassName()] = active || isOpen && !isInlineMode, _classnames2[this.getDisabledClassName()] = disabled, _classnames2[this.getSelectedClassName()] = this.isChildrenSelected(), _classnames2));
    return /*#__PURE__*/_react["default"].createElement("li", (0, _extends3["default"])({}, (0, _omit["default"])(restProps, ['renderMenuItem', 'onDestroy', 'manualRef', 'selectedKeys', 'openKeys', 'onMouseEnter', 'onMouseLeave', 'onTitleMouseEnter', 'prefixCls', 'inlineIndent', 'onItemHover', 'onOpenChange', 'onDeselect', 'onTitleMouseLeave', 'onTitleClick', 'subMenuKey']), mouseEvents, {
      className: cls,
      role: "menuitem"
    }), isInlineMode && titleNode, isInlineMode && childrenNode, !isInlineMode && /*#__PURE__*/_react["default"].createElement(_rcTrigger["default"], {
      prefixCls: prefixCls,
...
SubMenu.contextType = _context["default"];

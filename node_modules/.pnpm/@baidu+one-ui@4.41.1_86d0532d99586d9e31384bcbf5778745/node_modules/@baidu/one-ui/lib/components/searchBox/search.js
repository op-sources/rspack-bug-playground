...
var SearchBox = (_dec = (0, _context.withConfigConsumer)('search-box'), _dec(_class = (_temp = _class2 = /*#__PURE__*/function (_PureComponent) {
  (0, _inheritsLoose2["default"])(SearchBox, _PureComponent);
  ...
  function SearchBox(props) {
    ...
    _this.getInputClassName = function () {
      ...
      return (0, _commonTools.classnames)(prefixCls, prefixCls + "-" + size, (_classnames = {}, _classnames[prefixCls + "-disabled"] = disabled, _classnames[prefixCls + "-readOnly"] = readOnly, _classnames));
    };

    _this.getSubMenuItem = function (option) {
      var menuItemProps = {
        key: option.value,
        ref: (0, _partial2["default"])(_this.addAnchor, 'getMenuItemRef'),
        disabled: false
      };
      ...
      return /*#__PURE__*/_react["default"].createElement(MenuItem, menuItemProps, /*#__PURE__*/_react["default"].createElement(_searchText["default"], {
        text: option.label,
        showSearch: true,
    ...
    _this.renderIcon = function () {
      ...
      var closeProps = {
        ...
        className: (0, _commonTools.classnames)((_classnames2 = {}, _classnames2[prefixCls + "-icon"] = true, _classnames2[prefixCls + "-icon-close"] = true, _classnames2[prefixCls + "-icon-close-show"] = len && hasFocus, _classnames2[prefixCls + "-icon-close-spacing"] = !shouldShowSearchIcon || searchIconType === 'button' || searchIconType === 'custom', _classnames2)),
      ...
      return /*#__PURE__*/_react["default"].createElement("div", {
        ref: (0, _partial2["default"])(_this.addAnchor, 'searchIconAnchor'),
        className: prefixCls + "-icon-wrap"
      }, showCloseIcon ? /*#__PURE__*/_react["default"].createElement(_dlsIconsReact.IconTimesCircle, closeProps) : null, shouldShowSearchIcon && /*#__PURE__*/_react["default"].createElement("span", null, searchIconType === 'icon' && /*#__PURE__*/_react["default"].createElement(_button["default"], (0, _extends2["default"])({
        className: prefixCls + "-search-icon"
      }, searchProps, {
        icon: "search"
      })), searchIconType === 'button' && /*#__PURE__*/_react["default"].createElement(_button["default"], (0, _extends2["default"])({}, buttonProps, {
        icon: "search"
      })), searchIconType === 'custom' && /*#__PURE__*/_react["default"].createElement(_button["default"], buttonProps, customRender)));
    };
    ...
    _this.renderInput = function () {
      ...
      return /*#__PURE__*/_react["default"].createElement("input", (0, _extends2["default"])({}, otherProps, {
        className: (0, _commonTools.classnames)(_this.getInputClassName()),
        onKeyDown: _this.handleKeyDown,
        ref: (0, _partial2["default"])(_this.addAnchor, 'search')
      }));
    };
    ...
    (0, _warning["default"])(!('width' in props), 'The `width` prop of `SearchBox` is deprecated, use `className` or `style` instead');
    (0, _warning["default"])(!('height' in props), 'The `height` prop of `SearchBox` is deprecated, use `className` or `style` instead');
  ...
  _proto.render = function render() {
    ...
    var containerProps = {
      ref: (0, _partial2["default"])(this.addAnchor, 'container'),
      style: (0, _extends2["default"])({}, sizeStyle, style),
      className: (0, _commonTools.classnames)(className, (_classnames3 = {}, _classnames3[prefixCls + "-container"] = true, _classnames3[prefixCls + "-container-disabled"] = disabled, _classnames3[prefixCls + "-container-focused"] = hasFocus, _classnames3[(0, _config.COMPONENT_FOCUS)(lightPrefix)] = hasFocus, _classnames3), prefixCls + "-container-" + searchIconType, prefixCls + "-container-" + size)
    };
    var detailProps = {
      className: (0, _commonTools.classnames)(prefixCls + "-detail", (0, _config.COMPONENT_MAIN)(lightPrefix), (_classnames4 = {}, _classnames4[prefixCls + "-detail-focus"] = hasFocus, _classnames4[prefixCls + "-detail-disabled"] = disabled, _classnames4))
    };
    var overlayClassName = (0, _commonTools.classnames)((_classnames5 = {}, _classnames5[prefixCls + "-layer"] = true, _classnames5[className + "-layer"] = className, _classnames5));
    var layerProps = {
    ...
    return /*#__PURE__*/_react["default"].createElement("div", containerProps, /*#__PURE__*/_react["default"].createElement(_overlay["default"], layerProps, /*#__PURE__*/_react["default"].createElement("div", detailProps, this.renderInput(), this.renderIcon())));
  };

...
var Input = (_dec = (0, _context.withConfigConsumer)('input'), _dec(_class = (_temp = _class2 = /*#__PURE__*/function (_PureComponent) {
  ...
  _proto.getInputClassName = function getInputClassName() {
    ...
    return (0, _commonTools.classnames)(prefixCls, (_classnames = {}, _classnames[(0, _config.COMPONENT_MAIN)(lightPrefix)] = !(prefix || suffix), _classnames[prefixCls + "-focus"] = !(prefix || suffix) && this.state.hasFocus, _classnames[prefixCls + "-" + size] = size, _classnames[prefixCls + "-disabled"] = disabled, _classnames[prefixCls + "-readOnly"] = readOnly, _classnames));
  };
  ...
  _proto.renderLabeledIcon = function renderLabeledIcon(children) {
    ...
    var _this$props6 = this.props,
        ...
        lightPrefix = _this$props6.lightPrefix;
    ...
    var wrapperClassName = (0, _commonTools.classnames)(className, (0, _config.COMPONENT_MAIN)(lightPrefix), prefixCls + "-affix-wrapper", (_classnames3 = {}, _classnames3[prefixCls + "-affix-wrapper-has-prefix"] = !!prefix, _classnames3[prefixCls + "-affix-wrapper-has-suffix"] = !!suffix, _classnames3[prefixCls + "-affix-wrapper-disabled"] = disabled, _classnames3[prefixCls + "-focus"] = this.state.hasFocus, _classnames3));
  ...
  _proto.renderInput = function renderInput() {
    ...
    var otherProps = (0, _omit["default"])(props, ['prefixCls', 'onPressEnter', 'addonBefore', 'addonAfter', 'prefix', 'suffix', 'defaultValue', 'originInputProps', 'showClear', 'onClear'].concat(_inputTools.commonRemoveProps, ['filterArray', 'isErrorHTML', 'showErrorMessage', 'inputRef', 'lightPrefix']));
  ...
  _proto.render = function render() {
    ...
    var containerProps = {
      className: (0, _commonTools.classnames)(className, containerClass, containerClass + "-" + size, containerClass + "-" + type, (_classnames6 = {}, _classnames6[(0, _config.COMPONENT_INVALID)(lightPrefix)] = !!errorMessage, _classnames6[containerClass + "-error"] = errorMessage, _classnames6[containerClass + "-has-focused"] = hasFocus, _classnames6[(0, _config.COMPONENT_FOCUS)(lightPrefix)] = hasFocus, _classnames6[containerClass + "-has-suffix"] = !!suffix, _classnames6[containerClass + "-has-prefix"] = !!prefix, _classnames6[containerClass + "-error-bottom"] = errorLocation === 'bottom', _classnames6)),
    ...
    if (style.width === '100%' || width === '100%') {
      detailProps.style.width = width || style.width; // @ts-ignore

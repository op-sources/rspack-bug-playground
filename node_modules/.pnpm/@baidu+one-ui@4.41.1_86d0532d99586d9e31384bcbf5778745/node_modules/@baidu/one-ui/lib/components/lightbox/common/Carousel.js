...
var _dragTools = require("../../../core/dragTools");
...
var Carousel = /*#__PURE__*/(0, _react.forwardRef)(function (props, ref) {
  ...
  var positionObj = (0, _react.useRef)({
    mousePosition: {
      x: 0,
      y: 0
    },
  ...
  var videosRef = (0, _react.useRef)([]);
  var transformStyle = (0, _react.useMemo)(function () {
    var x = position.x,
        y = position.y;
    return {
  ...
  var onDragged = (0, _react.useCallback)(function (_ref) {
  ...
  var onMoving = (0, _react.useCallback)(function (_ref2) {
  ...
  var onDropped = (0, _react.useCallback)(function () {
    setIsDragging(false);
  }, []);
  ...
  return /*#__PURE__*/_react["default"].createElement("div", {
    ...
    return /*#__PURE__*/_react["default"].createElement("div", {
      ...
      className: (0, _commonTools.classnames)(prefixCls + "-container-item-media-img", isDragging && prefixCls + "-container-item-media-img-dragging", supportTransition && prefixCls + "-container-item-media-img-transition"),
      "data-active": active,
      src: "" + item.src,
      alt: "" + item.alt,
      style: transformStyle,
      onMouseDown: function onMouseDown(event) {
        return (0, _dragTools.onMouseDown)({
          event: event,
          onDragged: onDragged,
          onMoving: onMoving,
          onDropped: onDropped

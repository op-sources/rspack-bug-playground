...
var ImageItem = /*#__PURE__*/function (_PureComponent) {
  (0, _inheritsLoose2["default"])(ImageItem, _PureComponent);
  ...
  function ImageItem() {
    ...
    _this.renderItemOverlay = function (item) {
      ...
      return /*#__PURE__*/_react["default"].createElement("div", {
        className: (0, _commonTools.classnames)(prefixCls + "-entries-item-menus", prefixCls + "-entries-item-menus-" + size)
    ...
    _this.renderOptionIcon = function () {
      ...
      var previewIcon = type.indexOf('video') > -1 ? /*#__PURE__*/_react["default"].createElement(_dlsIconsReact.IconPlayCircle, {
        onClick: (0, _partial2["default"])(onPreview, index)
      }) : /*#__PURE__*/_react["default"].createElement(_dlsIconsReact.IconZoomIn, {
        onClick: (0, _partial2["default"])(onPreview, index)
      });

      var reUploadIcon = /*#__PURE__*/_react["default"].createElement(_dlsIconsReact.IconUpload, {
        onClick: (0, _partial2["default"])(onReUpload, index)
      });

      var trashIcon = /*#__PURE__*/_react["default"].createElement(_dlsIconsReact.IconTrash, {
        onClick: (0, _partial2["default"])(onRemove, index)
      });
      ...
      if (typeof controls === 'function') {
        ...
        actions[0].visible = !!(status === _uploaderTools.originStatus.SUCCESS && thumbUrl && showPreviewIcon);
        actions[1].visible = !!((status === _uploaderTools.originStatus.SUCCESS || status === _uploaderTools.originStatus.ERROR) && showReUploadIcon);
      ...
      return /*#__PURE__*/_react["default"].createElement("div", {
        ...
        var action = item.children && item.children.length ? /*#__PURE__*/_react["default"].createElement(_overlay["default"], {
          overlay: _this.renderItemOverlay(item),
          onVisibleChange: _this.onVisibleChange
        }, item.icon) : item.icon;
        return /*#__PURE__*/(0, _react.cloneElement)(action, {
          key: key
        });
      }));
    };
    ...
    _this.renderOpertaion = function (iconsSet) {
      ...
      return /*#__PURE__*/_react["default"].createElement("div", {
        className: (0, _commonTools.classnames)(prefixCls + "-image-item-card-operation", (_classnames = {}, _classnames[prefixCls + "-image-item-card-operation-hide"] = !iconsSet, _classnames[prefixCls + "-image-item-card-operation-overlay-open"] = _this.state.visible, _classnames))
  ...
  _proto.render = function render() {
    ...
    var itemClassNames = (0, _commonTools.classnames)(prefixCls + "-image-item", prefixCls + "-image-item-" + status, className, (_classnames2 = {}, _classnames2[prefixCls + "-image-item-helper-" + helperTextPosition] = showHelper && helperText, _classnames2));
    var iconsSet = this.renderOptionIcon();
    var iconContainer = this.renderOpertaion(iconsSet);

    var mediaIcon = /*#__PURE__*/_react["default"].createElement(_mediaIcon["default"], {
      theme: theme,
      type: realType,
    ...
    var imageItem = /*#__PURE__*/_react["default"].createElement("div", {
      className: (0, _commonTools.classnames)(prefixCls + "-image-item-card", (_classnames3 = {}, _classnames3[prefixCls + "-image-item-card-hide"] = !iconsSet, _classnames3))
    }, status === _uploaderTools.originStatus.WAITING || status === _uploaderTools.originStatus.ERROR && !thumbUrl ? /*#__PURE__*/_react["default"].createElement("div", {
      className: prefixCls + "-add-icon"
    }, pickerIcon || mediaIcon) : null, status === _uploaderTools.originStatus.UPLOADING ? /*#__PURE__*/_react["default"].createElement("div", {
      className: prefixCls + "-image-item-uploading-container"
    }, /*#__PURE__*/_react["default"].createElement("div", {
      className: prefixCls + "-image-item-uploading-text"
    }, "\u4E0A\u4F20\u4E2D"), /*#__PURE__*/_react["default"].createElement(_progress["default"], {
      size: "small",
      percent: progressStep,
      showInfo: false,
      className: prefixCls + "-image-item-progress"
    })) : null, status === _uploaderTools.originStatus.SUCCESS || thumbUrl ? /*#__PURE__*/_react["default"].createElement("span", {
      className: prefixCls + "-image-item-thumbUrl"
    }, thumbUrl ? /*#__PURE__*/_react["default"].createElement("img", {
      src: thumbUrl,
      alt: name,
      className: prefixCls + "-image-item-thumbUrl-image"
    }) : mediaIcon) : null, hasError && !thumbUrl ? /*#__PURE__*/_react["default"].createElement("div", {
    ...
    var error = hasError ? errorMessage.join('，') : null;
    return /*#__PURE__*/_react["default"].createElement("div", {
      className: itemClassNames
    }, /*#__PURE__*/_react["default"].createElement("div", null, hasError && errorDisplay === 'popup' ? /*#__PURE__*/_react["default"].createElement(_popover["default"], {
      content: error,
      overlayClassName: prefixCls + "-file-item-popover",
      placement: "top"
    }, imageItem) : imageItem, footer ? /*#__PURE__*/_react["default"].createElement("div", {
      className: prefixCls + "-image-item-card-footer"
    }, footer) : null, hasError && errorDisplay === 'normal' ? /*#__PURE__*/_react["default"].createElement("div", {

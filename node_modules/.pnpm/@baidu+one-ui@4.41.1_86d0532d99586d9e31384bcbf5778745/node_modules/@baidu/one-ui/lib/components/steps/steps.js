...
var Steps = (_dec = (0, _context.withConfigConsumer)('steps'), _dec(_class = (_temp = _class2 = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    ...
    var _this$props = this.props,
        ...
        restProps = (0, _objectWithoutPropertiesLoose2["default"])(_this$props, ["prefixCls", "style", "className", "children", "direction", "labelPlacement", "showTipWhenHover", "status", "size", "type", "current", "initialStep", "onClickStep", "onChange", "theme", "lightPrefix"]);
    var icons = {

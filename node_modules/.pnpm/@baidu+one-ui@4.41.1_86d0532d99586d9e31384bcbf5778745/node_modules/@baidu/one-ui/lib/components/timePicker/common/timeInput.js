...
var TimeInput = /*#__PURE__*/function (_PureComponent) {
  (0, _inheritsLoose2["default"])(TimeInput, _PureComponent);
  ...
  function TimeInput(props) {
    ...
    _this.onInputChange = function (event) {
      ...
      str = (0, _timePickerTools.fomatStr)(str);
    ...
    _this.onBlur = function () {
      _this.blurTimeout = setTimeout(function () {
        ...
        if (str && invalid) {
          // 为了小于10的数补上0
          _this.onInputChange({
            value: (0, _timePickerTools.addZero)(str),
            preFn: 'onBlur'
          });
        }
    ...
    _this.renderClearButton = function () {
      ...
      return isFocus && str ? /*#__PURE__*/_react["default"].createElement(_dlsIconsReact.IconTimesCircle, {
        onClick: _this.onClear,
        className: prefixCls + "-icon-close"
      }) : /*#__PURE__*/_react["default"].createElement(_dlsIconsReact.IconClock, {
  ...
  _proto.render = function render() {
    ...
    var wrapClass = (0, _commonTools.classnames)(prefixCls + "-input-wrap", (_classnames = {}, _classnames[prefixCls + "-input-wrap-error"] = errorMessage, _classnames));

...
;
var Select = (_dec = (0, _context.withConfigConsumer)('select'), _dec(_class = (_temp = _class2 = /*#__PURE__*/function (_PureComponent) {
  ...
  function Select(_props) {
    ...
    (0, _warning["default"])(!(showSearch == null && _mode === 'multiple'), 'The `showSearch` prop of `Select` in `multiple mode` will default to `false` in future versions. ' + 'Please set the value of `showSearch` prop as soon as possible.');
    return _this;
  }
  ...
  _proto.render = function render() {
    ...
    var prefixCls = props.prefixCls,
        ...
        _props$checkboxPrefix = props.checkboxPrefixCls,
        checkboxPrefixCls = _props$checkboxPrefix === void 0 ? lightPrefix + "-checkbox" : _props$checkboxPrefix,
        restProps = (0, _objectWithoutPropertiesLoose2["default"])(props, ["prefixCls", "className", "mode", "onChange", "width", "style", "multipleRenderTargetMode", "dropdownClassName", "customRenderTarget", "defaultVisible", "visible", "open", "suffixIcon", "showSearch", "lightPrefix", "checkboxPrefixCls"]);
    ...
    var selectCls = (0, _commonTools.classnames)(prefixCls + "-" + size, (0, _config.COMPONENT_MAIN)(lightPrefix), (_classnames = {}, _classnames[prefixCls + "-error-line"] = errorMessage, _classnames));
    ...
    var selectStyle = (0, _extends2["default"])({}, style);

    if (width) {
      selectStyle.width = width;
    }

    var dropdownCls = (0, _commonTools.classnames)(dropdownClassName, prefixCls + "-dropdown-" + size);

    if (!isMultiple && !isTags) {
      selectCls = (0, _commonTools.classnames)(selectCls, className);
      return /*#__PURE__*/_react["default"].createElement(_oneSelect["default"], (0, _extends2["default"])({}, restProps, modeConfig, {
        ref: this.saveSelect,
        prefixCls: prefixCls,
        className: selectCls,
        optionLabelProp: optionLabelProp,
        notFoundContent: notFoundContent,
        inputIcon: /*#__PURE__*/_react["default"].createElement(_dlsIconsReact.IconChevronDown, null),
    ...
    var selectRootCls = (0, _commonTools.classnames)(prefixCls + "-container", className, (_classnames2 = {}, _classnames2[prefixCls + "-multiple"] = isMultiple, _classnames2));
    return /*#__PURE__*/_react["default"].createElement("div", {
      className: selectRootCls
    }, /*#__PURE__*/_react["default"].createElement(_oneSelect["default"], (0, _extends2["default"])({}, restProps, modeConfig, {
      prefixCls: prefixCls,
      className: selectCls,
      optionLabelProp: optionLabelProp,
      notFoundContent: notFoundContent,

...
var Pagination = (_dec = (0, _context.withConfigConsumer)('pagination'), _dec(_class = (_temp = _class2 = /*#__PURE__*/function (_PureComponent) {
  ...
  function Pagination(_props) {
    ...
    _this.generateItemRender = function () {
      ...
      if (lastPage === 0) {
        itemList.push( /*#__PURE__*/_react["default"].createElement(_button["default"], {
          key: "none",
          size: size,
          type: "text",
          disabled: true
      ...
      if (lastPage < 7) {
        for (var i = 1; i <= lastPage; i++) {
          ...
          var itemProps = (0, _extends2["default"])({
            className: (0, _commonTools.classnames)(prefixCls + "-pager-item", (_classnames = {}, _classnames[prefixCls + "-pager-item-active"] = i === +pageNo, _classnames)),
            //@ts-ignore
            'data-key': i,
            key: i
          }, buttonProps);
          itemList.push( /*#__PURE__*/_react["default"].createElement(_button["default"], itemProps, i));
        }
      ...
      for (var _i = left; _i <= right; _i++) {
        ...
        var _itemProps = (0, _extends2["default"])({
          className: (0, _commonTools.classnames)(prefixCls + "-pager-item", (_classnames2 = {}, _classnames2[prefixCls + "-pager-item-active"] = _i === +pageNo, _classnames2)),
          //@ts-ignore
          'data-key': _i,
          key: _i
        }, buttonProps);

        itemList.push( /*#__PURE__*/_react["default"].createElement(_button["default"], _itemProps, _i));
      }

      if (pageNo - 1 >= pageBufferSize * 2 && pageNo !== 1 + pageBufferSize) {
        itemList.unshift( /*#__PURE__*/_react["default"].createElement(_tooltip["default"], {
          title: "\u5411\u524D 5 \u9875",
          key: "jump-prev"
          ...
          type: "text"
        }, /*#__PURE__*/_react["default"].createElement(_dlsIconsReact.IconEllipsis, {
      ...
      if (lastPage - pageNo >= pageBufferSize * 2 && pageNo !== lastPage - 2) {
        itemList.push( /*#__PURE__*/_react["default"].createElement(_tooltip["default"], {
          title: "\u5411\u540E 5 \u9875",
          key: "jump-next"
        }, /*#__PURE__*/_react["default"].createElement(_button["default"], {
      ...
      if (left !== 1) {
        itemList.unshift( /*#__PURE__*/_react["default"].createElement(_button["default"], (0, _extends2["default"])({
      ...
      if (right !== lastPage) {
        itemList.push( /*#__PURE__*/_react["default"].createElement(_button["default"], (0, _extends2["default"])({
          className: prefixCls + "-pager-item",
          "data-key": lastPage,
          key: lastPage
  ...
  _proto.render = function render() {
    ...
    var paginationProps = {
      className: (0, _commonTools.classnames)("" + prefixCls, className, (_classnames3 = {}, _classnames3[prefixCls + "-" + size] = size, _classnames3)),
      style: style
    };
    var paginationSelectProps = (0, _extends2["default"])({}, selectProps, {
      width: 'auto',
    ...
    return /*#__PURE__*/_react["default"].createElement("div", paginationProps, showTotal && /*#__PURE__*/_react["default"].createElement("div", {
      className: prefixCls + "-total"
    }, "\u5171 ", total || 0, " \u6761"), showSizeChange && total > 0 ? /*#__PURE__*/_react["default"].createElement("div", {
      className: prefixCls + "-select"
    }, /*#__PURE__*/_react["default"].createElement(_select["default"], paginationSelectProps, options.map(function (option) {
      ...
      className: (0, _commonTools.classnames)(prefixCls + "-pager-item " + prefixCls + "-pager-item-jumper", (_classnames4 = {}, _classnames4[prefixCls + "-pager-item-disabled"] = pageNo <= 1, _classnames4)),
      size: size,
      disabled: pageNo <= 1,
      onClick: this.goToPrevPage,
      type: "text",
      key: "pre"
    }, /*#__PURE__*/_react["default"].createElement(_dlsIconsReact.IconChevronLeft, null)), itemList.map(function (item) {
      return item;
    }), /*#__PURE__*/_react["default"].createElement(_button["default"], {
      className: (0, _commonTools.classnames)(prefixCls + "-pager-item " + prefixCls + "-pager-item-jumper", (_classnames5 = {}, _classnames5[prefixCls + "-pager-item-disabled"] = pageNo >= lastPage, _classnames5)),
      size: size,
      disabled: pageNo >= lastPage,
      onClick: this.goToNextPage,
      type: "text",
      key: "next"
    }, /*#__PURE__*/_react["default"].createElement(_dlsIconsReact.IconChevronRight, null))), showPageJumper && /*#__PURE__*/_react["default"].createElement("div", {
      className: prefixCls + "-jumper"
    }, /*#__PURE__*/_react["default"].createElement("span", {
      className: prefixCls + "-jumper-title"
    }, "\u53BB\u7B2C"), /*#__PURE__*/_react["default"].createElement(_numberInput["default"], {
      width: 40,
      ...
      className: prefixCls + "-jumper-title"
    }, "\u9875"), /*#__PURE__*/_react["default"].createElement(_button["default"], {

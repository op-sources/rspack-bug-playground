...
var BaseForm = /*#__PURE__*/function (_Component) {
  (0, _inheritsLoose2["default"])(BaseForm, _Component);
  ...
  function BaseForm(_props) {
    ...
    _this.getFieldDecorator = function (name, fieldOption) {
      ...
      return function (fieldElem) {
        ...
        return /*#__PURE__*/_react["default"].cloneElement(fieldElem, (0, _extends5["default"])({
    ...
    _this.getFieldProps = function (name, usersFieldOption) {
      ...
      var inputProps = (0, _extends5["default"])({}, _this.fieldsStore.getFieldValuePropValue(fieldOption), {
      ...
      inputProps[_formItem.FIELD_META_PROP] = meta;
      inputProps[_formItem.FIELD_DATA_PROP] = _this.fieldsStore.getField(name); // This field is rendered, record it
    ...
    _this.setFields = function (maybeNestedFields, callback) {
      ...
      if (onFieldsChange) {
        ...
        var changedFields = Object.keys(fields).reduce(function (acc, name) {
          return (0, _set3["default"])(acc, name, _this.fieldsStore.getField(name));
        }, {});
        onFieldsChange((0, _extends5["default"])((_extends2 = {}, _extends2[formPropName] = _this.form, _extends2), _this.props), changedFields, _this.fieldsStore.getNestedAllFields());
      }
    ...
    _this.setFieldsValue = function (changedValues, callback) {
      ...
      if (onValuesChange) {
        ...
        onValuesChange((0, _extends5["default"])((_extends3 = {}, _extends3[formPropName] = _this.form, _extends3), _this.props), changedValues, allValues);
      }
    };
    ...
    _this.setFieldsError = function (errors, callback) {
      ...
      var newFields = Object.keys(fieldsError).reduce(function (fields, name) {
        ...
        if (isRegistered) {
          ...
          fields[name] = (0, _extends5["default"])({}, _this.fieldsStore.getField(name), {
            errors: _errors
          });
        }
    ...
    _this.validateFields = function (ns, opt, cb) {
      var pending = new Promise(function (resolve, reject) {
        ...
        var fields = fieldNames.filter(function (name) {
          ...
          return (0, _formTools.hasRules)(fieldMeta.validate) || field.dirty || field.force;
        }).map(function (name) {
    ...
    _this.setFieldAsDirty = function (name) {
      ...
      _this.setFields((_this$setFields = {}, _this$setFields[name] = (0, _extends5["default"])({}, _this.fieldsStore.getField(name), {
        errors: undefined,
        warnings: undefined,
        successes: undefined,
    ...
    _this.validateFieldsAndScroll = function (ns, opt, cb) {
      var _getParams3 = (0, _formTools.getParams)(ns, opt, cb),
      ...
      var newCb = function newCb(_ref) {
        ...
        if (errors) {
          ...
          validNames.forEach(function (name) {
            if ((0, _has2["default"])(errors, name)) {
          ...
          if (firstNode) {
            var c = options.container || (0, _dom.getScrollableContainer)(firstNode);
            (0, _domScrollIntoView["default"])(firstNode, c, (0, _extends5["default"])({
    ...
    _this.scrollToField = function (name, options) {
      ...
      if (instance) {
        ...
        var container = options.container || (0, _dom.getScrollableContainer)(node);
        (0, _domScrollIntoView["default"])(node, container, {
          onlyScrollIfNeeded: true
        });
      }
    };
    ...
    _this.fieldsStore = (0, _createFieldsStore["default"])(_fields || {});
    _this.instances = {};
    _this.cachedBind = {};
    _this.clearedFieldMetaCache = {};
    _this.renderFields = {};
  ...
  BaseForm.getDerivedStateFromProps = function getDerivedStateFromProps(props, state) {
    ...
    if (mapPropsToFields && !(0, _shallowequal["default"])(props, prevProps)) {
  ...
  _proto.onCollectCommon = function onCollectCommon(name, action, args) {
    ...
    if (onValuesChange && value !== this.fieldsStore.getFieldValue(name)) {
      ...
      Object.keys(valuesAll).forEach(function (key) {
        return (0, _set3["default"])(valuesAllSet, key, valuesAll[key]);
      });
      onValuesChange((0, _extends5["default"])((_extends4 = {}, _extends4[formPropName] = this.form, _extends4), this.props), (0, _set3["default"])({}, name, value), valuesAllSet);
    }

    var field = this.fieldsStore.getField(name);
    return {
      name: name,
      field: (0, _extends5["default"])({}, field, {
        value: value,
        touched: true
      }),
      fieldMeta: fieldMeta
  ...
  _proto.getAsyncValidator = function getAsyncValidator(rule, value, options) {
    var validator = new _validator["default"](rule);
  ...
  _proto.mixValidateFields = function mixValidateFields(rules, values, options) {
    ...
    var warnings = [];
    var successes = [];
    return Promise.all((0, _map2["default"])(values, function (value, key) {
  ...
  _proto.validateFieldsInternal = function validateFieldsInternal(fields, fieldOptions, callback) {
    ...
    fields.forEach(function (field) {
      ...
      if (options.force !== true && dirty === false) {
        if (errors && errors.length) {
          (0, _set3["default"])(alreadyErrors, name, {
            errors: errors
          });
        }

        if (warnings && warnings.length) {
          (0, _set3["default"])(alreadyWarnings, name, {
            warnings: warnings
          });
        }

        if (successes && successes.length) {
          (0, _set3["default"])(alreadySuccesses, name, {
            successes: successes
          });
        }
      ...
      allFields[name] = (0, _extends5["default"])({}, field, {
        errors: undefined,
        warnings: undefined,
        successes: undefined,
        validating: true,
    ...
    this.mixValidateFields(allRules, allValues, options).then(function (messages) {
      ...
      Object.keys(allRules).forEach(function (name) {
        ...
        var fieldWarnings = (0, _get2["default"])(warningsGroup, name);
        var fieldSuccesses = (0, _get2["default"])(successesGroup, name);

        var nowField = _this4.fieldsStore.getField(name); // avoid concurrency problems


        if (!(0, _isEqual2["default"])(nowField.value, allValues[name])) {
          expired.push({
            name: name
          });
        } else {
      ...
      if (callback) {
        if (expired.length) {
          expired.forEach(function (_ref2) {
            ...
            (0, _set3["default"])(errorsGroup, name, {
              expired: true,
              errors: fieldErrors
            });
          });
        ...
        callback((0, _formTools.isEmptyObject)(errorsGroup) ? null : errorsGroup, _this4.fieldsStore.getFieldsValue(fieldNames));
      }
    });
  };
  ...
  _proto.getMessageGroup = function getMessageGroup(type, messages, allRules, typedMessages) {
    ...
    var messagesGroup = (0, _extends5["default"])({}, typedMessages);
    newMessages.forEach(function (e) {
      var fieldName = _this5.getFieldName(e.field, allRules);

      var field = (0, _get2["default"])(messagesGroup, fieldName);

      if (typeof field !== 'object' || Array.isArray(field)) {
        var _set2;

        (0, _set3["default"])(messagesGroup, fieldName, (_set2 = {}, _set2[type] = [], _set2));
      }

      var data = (0, _get2["default"])(messagesGroup, fieldName.concat("." + type));
      data.push(e);
    });
  ...
  _proto.render = function render() {
    ...
    var _this$props5 = this.props,
        ...
        restProps = (0, _objectWithoutPropertiesLoose2["default"])(_this$props5, ["wrappedComponentRef", "LegacyForm", "formPropName", "mapProps", "lightPrefix"]);
    var formProps = (_formProps = {}, _formProps[formPropName] = this.getForm(), _formProps);
    formProps.ref = wrappedComponentRef;
    var props = mapProps.call(this, (0, _extends5["default"])({}, formProps, restProps));

    if (LegacyForm) {
      return /*#__PURE__*/_react["default"].createElement(LegacyForm, props);
    }

    return /*#__PURE__*/_react["default"].createElement(_context.FormContext.Provider, {
      value: (0, _extends5["default"])({}, this.context, {
        form: this
      })
    }, this.props.children);
  };
...
BaseForm.defaultProps = {
  mapProps: _formTools.identity,
  formPropName: 'form',
  size: 'medium',
  fieldNameProp: 'id'
};
BaseForm.contextType = _context.FormContext;
;
...
var createBaseForm = function createBaseForm(option) {
  ...
  return function (LegacyForm) {
    return /*#__PURE__*/(0, _react.forwardRef)(function (props, ref) {
      return /*#__PURE__*/_react["default"].createElement(_context.LegacyFormContext.Provider, {
        value: {
          legacy: true
        }
      }, /*#__PURE__*/_react["default"].createElement(BaseForm, (0, _extends5["default"])({}, option, props, {
